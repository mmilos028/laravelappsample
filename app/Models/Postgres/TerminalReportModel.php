...
class TerminalReportModel
{
    ...
    public static function listSubjectMoneyTransactions($backoffice_session_id, $subject_id, $start_date, $end_date){
        try{
            ...
            if(self::$DEBUG){
                $message = "App\Models\Postgres\TerminalReportModel::listSubjectMoneyTransactions >>> 
                SELECT tomboladb.tombola.list_subjects_money_transactions(:p_session_id_in = {$backoffice_session_id}, :p_subject_id_in = {$subject_id}, :p_start_date, :p_end_date)";
            ...
            $message = implode(" ", [
                "TerminalReportModel::listSubjectMoneyTransactions(backoffice_session_id={$backoffice_session_id}, subject_id={$subject_id}, start_date={$start_date}, end_date={$end_date}) <br />\n\n",
    ...
    public static function listPlayerTickets($backoffice_session_id, $subject_id){
        try{
            ...
            if(self::$DEBUG){
                $message = "App\Models\Postgres\TerminalReportModel::listPlayerTickets >>> SELECT tomboladb.tombola.list_player_tickets(:p_session_id_in = {$backoffice_session_id}, :p_subject_id_in = {$subject_id}, 'cur_result_out')";
                ErrorHelper::writeInfo($message, $message);
            }
            ...
            DB::connection('pgsql')->rollBack();
            $message = implode(" ", [
                "TerminalReportModel::listPlayerTickets(backoffice_session_id={$backoffice_session_id}, subject_id={$subject_id}) <br />\n\n",
    ...
    public static function listPlayerLoginHistory($backoffice_session_id, $subject_id, $start_date, $end_date){
        try{
            ...
            if(self::$DEBUG){
                $message = "App\Models\Postgres\TerminalReportModel::listPlayerLoginHistory >>> 
                SELECT tomboladb.core.report_login_history(:p_session_id_in = {$backoffice_session_id}, :p_subject_id_in = {$subject_id}, :p_start_date = {$start_date}, :p_end_date = {$end_date}, 'cur_report_list')";
                ErrorHelper::writeInfo($message, $message);
            }
            ...
            DB::connection('pgsql')->rollBack();
            $message = implode(" ", [
                "TerminalReportModel::listPlayerTickets(backoffice_session_id={$backoffice_session_id}, subject_id={$subject_id}, start_date = {$start_date}, end_date = {$end_date}) <br />\n\n",
