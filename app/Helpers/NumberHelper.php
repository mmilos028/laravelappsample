...
class NumberHelper {
    ...
    public static function format_double_four_digits($inputDouble){
        return number_format($inputDouble, 4);
    }
    ...
    public static function convert_long($inputLong){
        return intval($inputLong);
    }

    public static function format_long($inputLong){
        return number_format($inputLong);
    }
}