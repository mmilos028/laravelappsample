...
class Handler extends ExceptionHandler
{
    ...
    public function render($request, Exception $exception)
    {
        ...
        if ($this->isHttpException($exception))
        {
            ...
            //$this->customRenderPageForException($request, $exception);
        }
    }

    private function customRenderPageForException($request,$exception){
        $error_msg = $exception->getTraceAsString();
        $error_msg_arr = $exception->getTrace();
        $message_trace = $this->getExceptionTraceAsString($exception);
    ...
    protected function unauthenticated($request, AuthenticationException $exception)
    {
        ...
        return redirect()->guest($this->loginPage);
    }
}
