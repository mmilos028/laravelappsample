...
class DepositPlayerTest extends DuskTestCase
{
    private $home_page = '/backoffice-tombola/public/en/home_page';
    private $backoffice_username = "";
    private $backoffice_password = "";
    private $test_url_page1 = "/transfer-credit/deposit-list";
    private $test_url_deposit_to_player = "/transfer-credit/cashier-player-deposit/user_id/";
    private $test_url_player_deposit_completed = "/transfer-credit/cashier-player-deposit-completed/user_id/";
    private $test_amount = 10.00;
    ...
    public function setUp()
    {
        ...
        $this->test_url_deposit_to_player = $this->test_url_deposit_to_player . getenv('ADMINISTRATOR_OPERATER_CHILD_PLAYER_ID');
        $this->test_url_player_deposit_completed = $this->test_url_player_deposit_completed . getenv('ADMINISTRATOR_OPERATER_CHILD_PLAYER_ID');
     ...
     * @throws \Throwable
     */
    public function testVisitDepositListPage()
    {
     ...
     * @throws \Throwable
     */
    public function testGoToDepositOnPlayerPage()
    {
        $this->browse(function (Browser $browser) {
            $browser->visit($this->test_url_deposit_to_player)
                ->assertPathIs(getenv('TEST_APPLICATION_NAME') . $this->test_url_deposit_to_player)
                ->assertSee('Transfer Amount')
            ;
            ...
            //print_r($this->new_player_amount);


            //test Do Deposit To Player
            $browser
                ->type('TRANSFER_AMOUNT', $this->test_amount)
                ->press('SUBMIT')
                ->assertPathIs(getenv('TEST_APPLICATION_NAME') . $this->test_url_player_deposit_completed)
                ->assertSee("Success!")
