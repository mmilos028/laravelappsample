...
class RootMasterDesktopBackofficeMenuTest extends DuskTestCase
{
    ...
    public function testViewAdministrationOnMainMenu(){
        $this->browse(function (Browser $browser){
            $browser
                ...
                ->assertSee(__("authenticated.Version Setup"))
    ...
    public function testViewReportsOnMainMenu(){
        $this->browse(function (Browser $browser){
            $browser
                ...
                ->assertSee(__("authenticated.All Machine Keys & Codes"))
