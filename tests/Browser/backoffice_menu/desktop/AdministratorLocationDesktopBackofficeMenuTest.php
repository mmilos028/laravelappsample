...
class AdministratorLocationDesktopBackofficeMenuTest extends DuskTestCase
{
    ...
    public function testViewAdministrationOnMainMenu(){
        $this->browse(function (Browser $browser){
            $browser
                ->assertDontSee(__("authenticated.Administration"))
            ;
        });
    }
    ...
    public function testViewStructureEntityOnMainMenu(){
        $this->browse(function (Browser $browser){
            $browser
                ...
                ->pause(1000)
                ->assertDontSee(__("authenticated.Structure View"))
            ;
        });
    }
