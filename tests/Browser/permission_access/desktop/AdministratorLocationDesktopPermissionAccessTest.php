...
class AdministratorLocationDesktopPermissionAccessTest extends DuskTestCase
{
    ...
    {
        $this->backoffice_username = getenv("ADMINISTRATOR_LOCATION_BACKOFFICE_USERNAME");
        $this->backoffice_password = getenv("ADMINISTRATOR_LOCATION_BACKOFFICE_PASSWORD");
    ...
    public function testViewUsersOnMainMenu(){
        $this->browse(function (Browser $browser){
            $browser
                ...
                ->visit("/listUsersTree")
                ->assertPathIs(getenv("TEST_APPLICATION_NAME") . "/listUsersTree")
