...
class RootMasterDesktopPermissionAccessTest extends DuskTestCase
{
    ...
    {
        $this->backoffice_username = getenv("ROOT_MASTER_BACKOFFICE_USERNAME");
        $this->backoffice_password = getenv("ROOT_MASTER_BACKOFFICE_PASSWORD");
    ...
    public function testViewAdministrationOnMainMenu(){
        $this->browse(function (Browser $browser){
            $browser
                ...
                ->assertPathIs(getenv("TEST_APPLICATION_NAME") . "/administration/version-setup/version-setup")

                ->visit("/administration/parameter-setup/add-new-parameter")
                ->assertPathIs(getenv("TEST_APPLICATION_NAME") . "/administration/parameter-setup/add-new-parameter")
    ...
    public function testViewUsersOnMainMenu(){
        $this->browse(function (Browser $browser){
            $browser
                ...
                ->visit("/deactivatedTerminals")
                ->assertPathIs(getenv("TEST_APPLICATION_NAME") . "/deactivatedTerminals")
    ...
    public function testViewReportsOnMainMenu(){
        $this->browse(function (Browser $browser){
            $browser
                ...
                ->visit("/affiliate-monthly-summary-report")
                ->assertPathIs(getenv("TEST_APPLICATION_NAME") . "/affiliate-monthly-summary-report")

                ->visit("/cashier-shift-report")
                ->assertPathIs(getenv("TEST_APPLICATION_NAME") . "/cashier-shift-report")
            ;
        });
    }
