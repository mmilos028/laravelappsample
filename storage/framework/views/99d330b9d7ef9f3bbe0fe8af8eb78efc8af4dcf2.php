    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <a href="<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/administration/list-draw-model-affiliates")); ?>" class="noblockui">
                        <?php echo e(__("authenticated.List Draw Model Affiliates")); ?>
            ...
            <div class="box">
                <div class="box-header">
                    <div class="row pull-right">
                        <div class="col-md-1">
                            <button id="reloadBtn" class="btn btn-primary"><span class="fa fa-refresh">&nbsp;</span><?php echo e(trans("authenticated.Reload")); ?></button>
                        </div>
                    </div>
                </div>
                <div class="box-body">
                        ...
                        <div id="tableContainer">
                            <table id="datatable" class="table table-bordered dataTable pull-left" style="width: 100%; font-size: 13px !important;">
                                ...
                                <tr id="tableHeader" class="bg-blue-active labelXS">
                                    <th width="100" style="text-align: left;"><?php echo e(__ ("authenticated.Username")); ?></th>
                                    <th width="100" style="text-align: left;"><?php echo e(__ ("authenticated.Role")); ?></th>
                                    <th width="100" style="text-align: left;"><?php echo e(__ ("authenticated.Parent")); ?></th>
                                    <th width="100" style="text-align: left;"><?php echo e(__ ("authenticated.Parent Role")); ?></th>
                                    <th width="100" style="text-align: left;"><?php echo e(__ ("authenticated.Draw Model")); ?></th>
                                    <th width="100" style="text-align: left;"><?php echo e(__ ("authenticated.Currency")); ?></th>
                                    <th width="100" style="text-align: left;"><?php echo e(__ ("authenticated.Control")); ?></th>
                                    <th width="100" style="text-align: left;"><?php echo e(__ ("authenticated.Super Draw")); ?></th>
                                    <th width="100" style="text-align: left;"><?php echo e(__ ("authenticated.Action")); ?></th>
                                </thead>
                            </table>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form accept-charset="UTF-8" id="changeDrawModalForm" class="form-horizontal row-border">
                        <div class="form-group">
                            <label for="affiliate" class="col-md-4 control-label"><?php echo e(trans("authenticated.Affiliate1")); ?>:</label>
                            <div class="col-md-6">
                                <input disabled class="form-control" placeholder="<?php echo e(trans("authenticated.Affiliate1")); ?>" name="location" type="text" id="affiliate">
                            </div>
                        </div>
                        <div class="form-group required">
                            <label for="draw_model" class="col-md-4 control-label"><?php echo e(trans("authenticated.Draw Model")); ?>:</label>
                            <div class="col-md-6">
                ...
                <div class="modal-footer">
                    <button type="button" id="closeDrawModelBtn" class="btn btn-default pull-right" data-dismiss="modal"><span class="fa fa-close">&nbsp;</span><?php echo e(trans("authenticated.Close")); ?></button>
                    <button style="display: none;" id="cancelDrawModelBtn" type="button" class="btn btn-danger pull-right"><span class="fa fa-close">&nbsp;</span><?php echo e(trans("authenticated.Cancel")); ?></button>
                    <button style="display: none;" id="saveDrawModelBtn" type="button" class="btn btn-primary pull-right"><span class="fa fa-save">&nbsp;</span><?php echo e(trans("authenticated.Save")); ?></button>
                    <button id="editDrawModelBtn" type="button" class="btn btn-success pull-right"><span class="fa fa-edit">&nbsp;</span><?php echo e(trans("authenticated.Edit")); ?></button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            function getReportData(){
                ...
                $.ajax({
                    method: "GET",
                    url: "<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "drawModelAffiliates")); ?>",
                    "dataSrc": "result",
                        ...
                        if(data.status == "OK"){
                            ...
                            $.each(data.result, function(index, value){
                                ...
                                if(value['draw_under_regulation'] == "<?php echo e(CONTROL); ?>"){
                                    control_free = "<?php echo e(trans('authenticated.Control')); ?>"+" (" + value['bet_win'] + " %) - " + value['currency'] + " - " + value["draw_model_activity"];
                                }else{
                                    control_free = "<?php echo e(trans('authenticated.Free')); ?> - " + value['currency'] + " - " + value["draw_model_activity"];
                                }
            ...
            function changeDrawModel(current_draw_model_id, draw_model_name, affiliate_id, affiliate_name){
                ...
                $.ajax({
                    method: "GET",
                    url: "<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "addDrawModelToAffiliate")); ?>",
                    data: {
                    ...
                    columns:[
                        ...
                        },
                        {
                            data: function(row, type, val, meta){
                                ...
                                if(draw_under_regulation == "<?php echo e(CONTROL); ?>"){
                                    draw_under_regulation = '<label class="label label-danger">' + '<?php echo e(trans("authenticated.Control")); ?>' + '</label>';
                                }else{
                                    draw_under_regulation = '<label class="label label-success">' + '<?php echo e(trans("authenticated.Free")); ?>' + '</label>';
                                }
                        ...
                        },
                        {
                            data: function(row, type, val, meta){
                                ...
                                if(super_draw == 1){
                                    super_draw = '<label class="label label-success">' + '<?php echo e(trans("authenticated.Yes")); ?>' + '</label>';
                                }else{
                                    super_draw = '<label class="label label-danger">' + '<?php echo e(trans("authenticated.No")); ?>' + '</label>';
                                }
                        ...
                        },
                        {
                            data: function(row, type, val, meta){
                                ...
                                return '<button class="btn btn-primary" onclick="openDrawModelForm(' + selected_draw_model_id + ',\'' + selected_draw_model_name + '\'' + ',\'' + selected_aff_id + '\'' + ',\'' + selected_aff_name + '\',\'' + selected_aff_currency + '\'' + ')"><span class="fa fa-edit">&nbsp;</span><?php echo e(__("authenticated.Change")); ?></button>';
                            },
                            width: 100,
                            className: "text-center",
                            bSearchable: false,
