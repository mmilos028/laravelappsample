...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><i class="fa fa-key"></i> <?php echo e(__("authenticated.Terminals")); ?></li>
            <li>
            ...
            <li class="active">
                <a href="<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/terminal/change-password/user_id/{$user['user_id']}")); ?>" title="<?php echo e(__('authenticated.Change Password')); ?>">
                    <?php echo e(__("authenticated.Change Password")); ?>
    ...
    <section class="content">
        ...
        <div class="widget box col-md-4">
            ...
            <div class="widget-content">
                <?php echo Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "terminal/change-password/user_id/{$user['user_id']}"), 'method'=>'POST', 'class' => 'form-horizontal row-border' ]); ?>
