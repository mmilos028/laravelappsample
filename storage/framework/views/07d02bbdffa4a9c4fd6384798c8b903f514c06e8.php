...
<script type="text/javascript">
    function calculateWidths(){
        var tableWidth = [];
		$("#search-entity-small > thead > tr.bg-blue-active > th").each(function(index, value) {
			tableWidth.push(value.width);
		});

		$("#search-entity-small > tbody > tr").each(function(index, value){
...
$(document).ready(function() {
    ...
    var table = $('#search-entity-small').DataTable({
        initComplete: function (settings, json) {
            $("#search-entity-small_length").addClass("pull-right");
            $("#search-entity-small_filter").addClass("pull-left");
        },
        scrollX: true,
        scrollY: "50vh",
        "order": [],
    ...
    document.getElementById('search-entity-small_wrapper').removeChild(
        document.getElementById('search-entity-small_wrapper').childNodes[0]
    );
...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><i class="fa fa-search"></i> <?php echo e(__("authenticated.Structure Entity")); ?></li>
            <li class="active">
    ...
    <section class="content">
        ...
        <div class="box">
            <?php echo Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), 'structure-entity/search-entity'), 'method'=>'POST',
            'class' => 'row-border' ]); ?>
            ...
            <div class="box-body">
                ...
                <hr>
				<div class="">
	                <table style="width: 100%;" id="search-entity-small" class="table table-bordered table-hover table-striped pull-left">
                        <?php if($subject_type == config("constants.SELF_SERVICE_TERMINAL_ID")): ?>
                            <thead>
                            <tr class="bg-blue-active">
                                <th width="100"><?php echo e(__("authenticated.MAC Address")); ?></th>
                                <th width="100"><?php echo e(__("authenticated.Parent Name")); ?></th>
                                <th width="100"><?php echo e(__("authenticated.Role")); ?></th>
                                <th width="100"><?php echo e(__("authenticated.Terminal Name")); ?></th>
                            ...
                            <?php $__currentLoopData = $list_users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td width="100" class="align-left" title="<?php echo e(__("authenticated.MAC Address")); ?>">
                                    ...
                                    <td width="100" class="align-left" title="<?php echo e(__("authenticated.Terminal Name")); ?>">
                                    ...
                                    <td width="100" class="align-center" title="<?php echo e(__("authenticated.Account Status")); ?>">
                                        <a href="<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/structure-entity/change-user-account-status/user_id/{$user->subject_id}")); ?>" title="<?php echo e(__("authenticated.Change Account Status")); ?>">
