...
<html>
    ...
    <link rel="stylesheet" href="<?php echo e(url('css/backoffice/additional-bootstrap-buttons.css')); ?>" type="text/css" />
        <link rel="stylesheet" href="<?php echo e(url('css/backoffice/desktop_layout_fix.css')); ?>" type="text/css" />
    ...
    <script type="text/javascript" src="<?php echo e(url('js/backoffice/desktop/filter-input-text.js')); ?>"></script>
...
<body class="skin-blue fixed sidebar-mini layout-top-nav sidebar-collapse" <?php if(Config::get('ENABLE_RIGHT_CLICK_ON_PAGE')): ?> oncontextmenu="return false;" <?php endif; ?>>
<div class="wrapper">
    ...
    <?php echo $__env->make('layouts.desktop_layout.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <!-- =============================================== -->
    ...
    <?php echo $__env->make('layouts.desktop_layout.footer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
</div>
