    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                ...
                <?php echo e(__("authenticated.Daily Report")); ?>
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><?php echo e(__("authenticated.Daily Report")); ?></li>
            </ol>
        </section>
                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    ...
                                    <div class="col-md-1 col-xs-2 padding" style="display: none;">
                                        <button id="collapseToRootBtn" class="btn primary" data-toggle="tooltip" data-placement="top" title="<?php echo e(__("authenticated.Home")); ?>" onclick="collapseAll()">
                            ...
                            <?php if($agent->isDesktop()): ?>
                                <div class="col-md-4">
                                    <div class="input-group date startdate">
                                        <div class="">
                                            <?php echo Form::label('reportDate', trans('authenticated.For Date') . ':', array('class' => 'control-label label-break-line')); ?>

                                            <div class="input-group date">
                                                <?php echo Form::text('reportDate', $report_end_date,
                                                        array(
                                                              'class'=>'form-control',
                                                              'readonly'=>'readonly',
                                                              'size' => 12,
                    ...
                    <div class="row">
                        ...
                        <div id="tablesContainer" class="col-md-8 animate">
                            <div class="jumbotron" id="infoBox" align="center">
                                <div class="container">
                                    <p><?php echo e(__('authenticated.This report is possible only for Locations and Cashiers.')); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6" id="locationContainer" style="display: none;">
                                <h2 class="text-light-blue"><?php echo e(__('authenticated.Location')); ?> &nbsp;<strong id="locationName"></strong></h2>
                                <form id="locationReport" class="form-horizontal row-border">
                                    ...
                                    <div class="row">
                                       <div class="col-md-5">
                                           <div class="form-group">
                                               <label for="number_of_deposits_location" class="control-label labelXS"><?php echo e(__('authenticated.Number Of Deposits')); ?>:</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="deposit_total_location" class="control-label labelXS"><?php echo e(__('authenticated.Deposit Total')); ?>:</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label for="number_of_cashiers_deposits_location" class="control-label labelXS"><?php echo e(__('authenticated.Cashier Deposits')); ?>:</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="deposit_cashier_total_location" class="control-label labelXS"><?php echo e(__('authenticated.Cashier Total Deposit')); ?>:</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label for="number_of_online_deposits_location" class="control-label labelXS"><?php echo e(__('authenticated.Online Deposits')); ?>:</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="deposit_online_total_location" class="control-label labelXS"><?php echo e(__('authenticated.Online Deposit Total')); ?>:</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label for="number_of_canceled_deposits_location" class="control-label labelXS"><?php echo e(__('authenticated.Canceled Deposits')); ?></label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="deposit_canceled_total_location" class="control-label labelXS"><?php echo e(__('authenticated.Canceled Deposit Total')); ?>:</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label for="number_of_withdraws_location" class="control-label labelXS"><?php echo e(__('authenticated.Number Of Withdraws')); ?>:</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="withdraw_total_location" class="control-label labelXS"><?php echo e(__('authenticated.Withdraw Total')); ?>:</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label for="number_of_cashier_withdraws_location" class="control-label labelXS"><?php echo e(__('authenticated.Cashier Withdraws')); ?>:</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="withdraw_cashier_total_location" class="control-label labelXS"><?php echo e(__('authenticated.Cashier Withdraw Total')); ?>:</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label for="number_of_online_withdraws_location" class="control-label labelXS"><?php echo e(__('authenticated.Online Withdraws')); ?>:</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="withdraw_online_total_location" class="control-label labelXS"><?php echo e(__('authenticated.Online Withdraw Total')); ?>:</label>
                            ...
                            <div class="col-md-6" id="cashierContainer" style="display: none;">
                                <h2 class="text-light-blue"><?php echo e(__('authenticated.Cashier')); ?> &nbsp;<strong id="cashierName"></strong></h2>
                                <form id="cashierReport" class="form-horizontal row-border">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="start_balance_cashier" class="control-label labelXS"><?php echo e(__('authenticated.Start Balance')); ?>:</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label for="number_of_deposits_cashier" class="control-label labelXS"><?php echo e(__('authenticated.Number Of Deposits')); ?>:</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="deposit_total_cashier" class="control-label labelXS"><?php echo e(__('authenticated.Deposit Total')); ?>:</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label for="number_of_cashiers_deposits_cashier" class="control-label labelXS"><?php echo e(__('authenticated.Cashier Deposits')); ?>:</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="deposit_cashier_total_cashier" class="control-label labelXS"><?php echo e(__('authenticated.Cashier Deposit Total')); ?>:</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label for="number_of_online_deposits_cashier" class="control-label labelXS"><?php echo e(__('authenticated.Online Deposits')); ?>:</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="deposit_online_total_cashier" class="control-label labelXS"><?php echo e(__('authenticated.Online Deposit Total')); ?>:</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label for="number_of_canceled_deposits_cashier" class="control-label labelXS"><?php echo e(__('authenticated.Canceled Deposits')); ?>:</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="deposit_canceled_total_cashier" class="control-label labelXS"><?php echo e(__('authenticated.Canceled Deposit Total')); ?>:</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label for="number_of_withdraws_cashier" class="control-label labelXS"><?php echo e(__('authenticated.Number Of Withdraws')); ?>:</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="withdraw_total_cashier" class="control-label labelXS"><?php echo e(__('authenticated.Withdraw Total')); ?>:</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label for="number_of_cashier_withdraws_cashier" class="control-label labelXS"><?php echo e(__('authenticated.Cashier Withdraws')); ?>:</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="withdraw_cashier_total_cashier" class="control-label labelXS"><?php echo e(__('authenticated.Cashier Withdraw Total')); ?>:</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label for="number_of_online_withdraws_cashier" class="control-label labelXS"><?php echo e(__('authenticated.Online Withdraws')); ?>:</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="withdraw_online_total_cashier" class="control-label labelXS"><?php echo e(__('authenticated.Online Withdraw Total')); ?>:</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="end_balance_cashier" class="control-label labelXS"><?php echo e(__('authenticated.End Balance')); ?>:</label>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body bg-info">
                    <p id="modal-body-p">
                        <strong><?php echo e(trans("authenticated.This report shows cashier and location totals.")); ?></strong>
                        <br><br>
                        <?php echo e(trans("authenticated.Data is retrieved for selected subject and selected day.")); ?>
    ...
    <script>
        $(document).ready(function(){
                ...
                onLoadSuccess: function() {
                    ...
                    if(automaticSelect == "yes"){
                        ...
                        if(properties === null){
                            ...
                            if(selected_subject_type_id == "<?php echo e(config('constants.LOCATION_TYPE_ID')); ?>" || selected_subject_type_id == "<?php echo e(config('constants.CASHIER_TYPE_ID')); ?>" || selected_subject_type_id == "<?php echo e(config('constants.SHIFT_CASHIER_TYPE_ID')); ?>"){
                                document.getElementById("infoBox").style.display = "none";

                                if(selected_subject_type_id == "<?php echo e(config('constants.LOCATION_TYPE_ID')); ?>"){
                                ...
                                }else if(selected_subject_type_id == "<?php echo e(config('constants.CASHIER_TYPE_ID')); ?>" || selected_subject_type_id == "<?php echo e(config('constants.SHIFT_CASHIER_TYPE_ID')); ?>"){
                                    document.getElementById("locationContainer").style.display = "inline";
            ...
            function generateReport(subject_id, date, selected_subject_type_id, selected_subject_username){
                $.ajax({
                    method: "GET",
                    url: "<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "cashierDailyReportAjax")); ?>",
                    dataType: "json",
                    data: {
