    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                ...
                <?php echo e(__("authenticated.Structure View")); ?>

                &nbsp;
            </h1>
            <ol class="breadcrumb">
                <li><i class="fa fa-tree"></i> <?php echo e(__("authenticated.Structure Entity")); ?></li>
                <li class="active">
                    <a href="<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/structure-entity/list-users-tree")); ?>" title="<?php echo e(__('authenticated.Structure View')); ?>">
                        <?php echo e(__("authenticated.Structure View")); ?>
                    ...
                    <div class="row">
                        <?php if($agent->isDesktop()): ?>
                            <div class="col-md-1 col-xs-2 padding">
                                <button id="reloadTreeBtn" class="btn btn-block btn-primary" onclick="reload()" data-toggle="tooltip" data-placement="top" title="<?php echo e(__("authenticated.Reload")); ?>">
                            ...
                            <div class="col-md-1 col-xs-2 padding">
                                <button id="showDirectTreeBtn" class="btn btn-block btn-primary" data-toggle="tooltip" data-placement="top" title="<?php echo e(__("authenticated.Direct")); ?>" onclick="collapseNotRoot()">
                                    <span class = "fa fa-home"></span>
                                </button>
                            </div>
                            <div class="col-md-1 col-xs-2 padding">
                                <button id="expandTreeBtn" class="btn btn-block btn-primary" data-toggle="tooltip" data-placement="top" title="<?php echo e(__("authenticated.All")); ?>" onclick="expandAll()">
                                    <span class = "fa fa-bars"></span>
                                </button>
                            </div>
                            <div class="col-md-2 col-xs-2 padding" id="showTerminalsContainer">
                                <button id="showTerminalsBtn" class="btn btn-block btn-primary" onclick="showTerminals()" data-toggle="tooltip" data-placement="top" title="<?php echo e(__("authenticated.Show Cashier, TV and Self-Service Terminal")); ?>">
                                    <span class = "fa fa-plus"></span>
                                    <?php echo e(__("authenticated.Show Terminals")); ?>

                                </button>
                            </div>
                            <div class="col-md-2 col-xs-2 padding" id="hideTerminalsContainer" style="display: none;">
                                <button id="hideTerminalsBtn" class="btn btn-block btn-primary" onclick="hideTerminals()" data-toggle="tooltip" data-placement="top" title="<?php echo e(__("authenticated.Hide Cashier, TV and Self-Service Terminal")); ?>">
                                    <span class = "fa fa-minus"></span>
                                    <?php echo e(__("authenticated.Hide Terminals")); ?>
                        ...
                        <?php else: ?>
                            ...
                            <div class="col-md-1 col-xs-2 padding" style="display: none;">
                                <button id="collapseToRootBtn" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="<?php echo e(__("authenticated.Home")); ?>" onclick="collapseAll()">
                                    <span class = "fa fa-home"></span>
                                </button>
                            </div>
                            <div class="col-md-1 col-xs-2 padding">
                            ...
                            <div class="col-md-2 col-xs-2 padding" id="showTerminalsContainer">
                                <button id="showTerminalsBtn" class="btn btn-primary" onclick="showTerminals()" data-toggle="tooltip" data-placement="top" title="<?php echo e(__("authenticated.Show Cashier, TV and Self-Service Terminal")); ?>">
                                    <span class = "fa fa-plus"></span>
                                    <?php echo e(__("authenticated.Show Terminals")); ?>
                            ...
                            <div class="col-md-2 col-xs-2 padding" id="hideTerminalsContainer" style="display: none;">
                                <button id="hideTerminalsBtn" class="btn btn-primary" onclick="hideTerminals()" data-toggle="tooltip" data-placement="top" title="<?php echo e(__("authenticated.Hide Cashier, TV and Self-Service Terminal")); ?>">
                                    <span class = "fa fa-minus"></span>
                                    <?php echo e(__("authenticated.Hide Terminals")); ?>
    ...
    <script>
        $(document).ready(function(){
            ...
            window.showTerminals = function(){
                ...
                $('#tree1').treegrid('options').url = '<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "getSubjectTree")); ?>?showTerminals=' + showTerminals;
            ...
            var tree = $('#tree1').treegrid({
                method: 'GET',
                url: '<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "getSubjectTree")); ?>?showTerminals=' + showTerminals,
                ...
                columns:[[
                    ...
                    {title: "<?php echo e(__("authenticated.Role")); ?>",field:'subject_type_name_colourful',width:200},
