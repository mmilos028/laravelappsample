                    ...
                    <div class="box">
                        <div class="box-body">
                            <?php echo $__env->make('layouts.shared.form_messages', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                <?php echo Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), 'transfer-credit/cashier-player-deposit/user_id/' . $user_id), 'method'=>'POST' ]); ?>
                                            ...
                                            <div class="form-group">
                                                <div class="col-xs-5 pull-left">
                                                    <label class="control-label" for="DIRECT_PLAYER_NAME">
                                                        <?php echo e(__("authenticated.Player Name")); ?>

                                                    </label>
                                                </div>
                                                <div class="col-xs-7 pull-left">
                                                    <input type="text" value="<?php echo e($player_username); ?>" class="form-control margin-1 bold-text darkgray_input_text_field" name="DIRECT_PLAYER_NAME" id="DIRECT_PLAYER_NAME" readonly />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <?php if($errors->has('DIRECT_PLAYER_NAME')): ?>
                                    <div class="row" style="max-width: 600px;">
                                        <div class="col-xs-12">
                                            <span class="help-block alert alert-danger alert-dismissible fade in">
                                                <strong><?php echo e($errors->first('DIRECT_PLAYER_NAME')); ?></strong>
                                            </span>&nbsp;
                                        </div>
                                    </div>
                                    <?php endif; ?>
                                            ...
                                            <div class="form-group">
                                                <div class="col-xs-5 pull-left">
                                                    <label class="control-label" for="PLAYER_CREDIT_STATUS">
                                                        <?php echo e(__("authenticated.Player Credit Status")); ?>

                                                    </label>
                                                </div>
                                                <div class="col-xs-7 pull-left">
                                                    <input type="text" value="<?php echo e($player_credits_formatted); ?>" class="form-control margin-1 bold-text darkgray_input_text_field right-text-align" name="PLAYER_CREDIT_STATUS" id="PLAYER_CREDIT_STATUS" readonly />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <?php if($errors->has('PLAYER_CREDIT_STATUS')): ?>
                                    <div class="row" style="max-width: 600px;">
                                        <div class="col-xs-12">
                                            <span class="help-block alert alert-danger alert-dismissible fade in">
                                                <strong><?php echo e($errors->first('PLAYER_CREDIT_STATUS')); ?></strong>
                                            </span>&nbsp;
                                        </div>
                                    </div>
                                    <?php endif; ?>
                                            ...
                                            <div class="form-group">
                                                <div class="col-xs-5 pull-left">
                                                    <label class="control-label" for="PLAYER_CURRENCY">
                                                        <?php echo e(__("authenticated.Currency")); ?>

                                                    </label>
                                                </div>
                                                <div class="col-xs-7 pull-left">
                                                    <input type="text" value="<?php echo e($player_currency); ?>" class="form-control margin-1 bold-text darkgray_input_text_field right-text-align" name="PLAYER_CURRENCY" id="PLAYER_CURRENCY" readonly />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <?php if($errors->has('PLAYER_CURRENCY')): ?>
                                    <div class="row" style="max-width: 600px;">
                                        <div class="col-xs-12">
                                            <span class="help-block alert alert-danger alert-dismissible fade in">
                                                <strong><?php echo e($errors->first('PLAYER_CURRENCY')); ?></strong>
                                            </span>&nbsp;
                                        </div>
                                    </div>
                                    <?php endif; ?>
                                            ...
                                            <div class="form-group">
                                                <div class="col-xs-5 pull-left">
                                                    <label class="control-label" for="TRANSFER_AMOUNT">
                                                        <?php echo e(__("authenticated.Transfer Amount")); ?>
                                    ...
                                    <?php if($errors->has('TRANSFER_AMOUNT')): ?>
                                    <div class="row" style="max-width: 600px;">
                                        <div class="col-xs-12">
                                            <span class="help-block alert alert-danger alert-dismissible fade in">
                                                <strong><?php echo e($errors->first('TRANSFER_AMOUNT')); ?></strong>
                                            </span>&nbsp;
                                        </div>
                                    </div>
                                    <?php endif; ?>
                                    ...
                                    <div class="row" style="max-width: 600px;">
                                        <div class="col-md-4 col-sm-4 col-xs-4">
                                            ...
                                            <button class="btn btn-primary btn-block" type="submit" name="SUBMIT" id="SUBMIT"><?php echo e(__("authenticated.Add")); ?></button>
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-4">
                                            <button type="button" id="backBtn" class="btn btn-warning btn-block" title="<?php echo e(__('authenticated.Back')); ?>">
                                    ...
                                    <div class="row" style="max-width: 600px; display: none;">
                                        ...
                                        <div class="col-xs-6">
                                            <input type="submit" class="btn btn-warning btn-lg btn-block noblockui" name="PREVIOUS_PAGE" id="PREVIOUS_PAGE" value="<?php echo e(__("authenticated.Previous Page")); ?>" />
                                        </div>
                                    </div>
                                    <div class="row invincible">
                                        <div class="col-xs-12">
                                            <input type="hidden" name="CASHIER_ID" id="CASHIER_ID" value="<?php echo e($logged_user_id); ?>" />
                                            <input type="hidden" name="CASHIER_CREDIT_STATUS_HIDDEN" id="CASHIER_CREDIT_STATUS_HIDDEN" value="<?php echo e($user_credits); ?>" />
                                            <input type="hidden" name="PLAYER_CREDIT_STATUS_HIDDEN" id="PLAYER_CREDIT_STATUS_HIDDEN" value="<?php echo e($player_credits); ?>" />
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">
                        <?php echo e(__("authenticated.Amount is too large")); ?>

                    </h4>
                </div>
                <div class="modal-body">
                    <?php echo e(__("authenticated.Value cannot be bigger than affiliate balance.")); ?>

                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-dismiss="modal" onclick="closeErrorDialog()"><?php echo e(__("authenticated.Close")); ?></button>
                </div>
            </div>
        </div>
    </div>
