...
<div class="row">
    <a class="btn btn-app noblockui" href="<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/administrator/list-administrators")); ?>">
        <i class="fa fa-search"></i>
        <?php echo e(__('authenticated.List Administrators')); ?>

        <span class="sr-only">(current)</span>
    </a>
    <a class="btn btn-app noblockui" href="<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/administrator/details/user_id/{$user_id}")); ?>">
        <i class="fa fa-info"></i>
        <?php echo e(__('authenticated.Account Details')); ?>

        <span class="sr-only">(current)</span>
    </a>
    <a class="btn btn-app noblockui" href="<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/administrator/update-administrator/user_id/{$user_id}")); ?>">
        <i class="fa fa-edit"></i>
        <?php echo e(__('authenticated.Update Administrator')); ?>

        <span class="sr-only">(current)</span>
    </a>
    <a class="btn btn-app noblockui" href="<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/administrator/change-password/user_id/{$user_id}")); ?>">
