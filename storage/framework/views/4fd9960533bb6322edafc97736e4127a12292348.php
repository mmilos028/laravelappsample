                                ...
                                <div class="col-md-2">
                                    <div class="btn-group" style="padding-top: 30px !important; width: 100% !important;">
                                        ...
                                        <ul class="dropdown-menu pull-right" role="menu">
                                            ...
                                            <li class="divider"></li>
                                            <li>
                                                <?php echo Form::button('<i class="fa fa-expand"></i> ' . trans('authenticated.Large'),
										        array(
											    'class'=>'btn btn-default btn-block',
											    'type'=>'submit',
											    'name'=>'large',
					...
					<table style="width: 100%;" id="search-tickets" class="table table-bordered table-hover table-striped">
						<thead>
							<tr class="bg-blue-active">
                                ...
                                <th width="110"><?php echo e(__("authenticated.Barcode")); ?></th>
                                ...
                                <th width="130"><?php echo e(__("authenticated.Date & Time")); ?></th>
                                <th width="80"><?php echo e(__("authenticated.Cashier")); ?></th>
                                <th width="130"><?php echo e(__("authenticated.Player Username")); ?></th>
								...
								<th width="110"><?php echo e(__("authenticated.Ticket Printed")); ?></th>
						...
						<tbody>
							...
							<tr>
								<td width="80" class="align-left" title="<?php echo e(__("authenticated.Serial Number")); ?>">
                                ...
                                <td width="110" class="align-right" title="<?php echo e(__("authenticated.Barcode")); ?>">
                                ...
                                <td width="130" class="align-center" title="<?php echo e(__("authenticated.Date & Time")); ?>">
                                    <?php echo e($ticket->rec_tmstp_formated); ?>

                                </td>
                                <td width="80" title="<?php echo e(__("authenticated.Cashier")); ?>">
                                    <?php echo e($ticket->cashier); ?>

                                </td>
                                <td width="130" class="align-left" title="<?php echo e(__("authenticated.Player Username")); ?>">
                                ...
                                <td width="80" class="align-right" title="<?php echo e(__("authenticated.Ticket Repeat")); ?>">
								...
								<td width="110" class="align-center" title="<?php echo e(__("authenticated.Ticket Printed")); ?>">
									<?php echo $__env->make('layouts.shared.status_yes_no',
