    ...
    <section class="content-header">
      <?php echo $__env->make('layouts.desktop_layout.header_navigation_second', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <a href="<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/structure-entity/details/user_id/{$user['user_id']}")); ?>" title="<?php echo e(__('authenticated.Account Details')); ?>">
                    <?php echo e(__("authenticated.Account Details")); ?>
            ...
            <div class="widget box" style="margin-top:20px;">
              <div class="widget-header">
                ...
                <span class="pull-right">
                  <a href="<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/structure-entity/change-password/user_id/{$user['user_id']}")); ?>">
