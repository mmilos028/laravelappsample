...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                ...
                <?php echo e(__("authenticated.JackPot Setup")); ?>
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <a href="<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/jackPotSetup")); ?>" class="noblockui">
                        <?php echo e(__("authenticated.JackPot Setup")); ?>
        ...
        <section class="content">
            ...
            <?php if(session("auth.subject_type_id") == config("constants.ADMINISTRATOR_SYSTEM_ID") || session("auth.subject_type_id") == config("constants.MASTER_TYPE_ID")): ?>
            <div class="box">
                <div class="box-body">
                    <div class="col-md-2">
                        <button id="showNewJPModelForm" class="btn btn-primary"><span class="fa fa-plus">&nbsp;</span><?php echo e(__ ("authenticated.Add JackPot Specification")); ?></button>

                    </div>
                </div>
            </div>
            <?php else: ?>
            <button style="display: none;" id="showNewJPModelForm" class="btn btn-primary"><span class="fa fa-plus">&nbsp;</span><?php echo e(__ ("authenticated.Add JackPot Specification")); ?></button>
            <?php endif; ?>

            <div class="box animate fadeOut" id="newJpModelBox" style="display: none;">
                <div class="box-header">
                    <h3 class="box-title"><?php echo e(__ ("authenticated.New JP Model")); ?></h3>
                </div>
                <div class="box-body">
                    <form id="newJackpotModelForm" class="form-horizontal">
                        ...
                        <?php if($agent->isDesktop()): ?>
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group required">
                                        <label for="name" class="col-md-4 control-label"><?php echo e(__ ("authenticated.Name")); ?>:</label>
                                        <div class="col-md-6">
                                            <input class="form-control" placeholder="<?php echo e(__ ("authenticated.Name")); ?>" name="name" type="text" id="name">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        <label for="minNoOfTickets" class="col-md-6 control-label"><?php echo e(__ ("authenticated.Min no. of tickets in draw to win")); ?>:</label>
                                        <div class="col-md-6">
                                            <input step="0.01" min="0" class="form-control" placeholder="<?php echo e(__ ("authenticated.Min no. of tickets in draw to win")); ?>" name="minNoOfTickets" type="number" id="minNoOfTickets">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group required">
                                        <label for="currency" class="col-md-4 control-label"><?php echo e(__ ("authenticated.Currency")); ?>:</label>
                                        <div class="col-md-6">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        <label for="fromHours" class="col-md-6 control-label"><?php echo e(__ ("authenticated.JackPot possible to win (from hours)")); ?>:</label>
                                        <div class="col-md-6">
                                            <input min="0" class="form-control" placeholder="<?php echo e(__ ("authenticated.JackPot possible to win (from hours)")); ?>" name="fromHours" type="number" id="fromHours">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group required">
                                        <label for="globalJPOnOff" class="col-md-2 control-label"><?php echo e(__ ("authenticated.Global JP")); ?>:</label>
                                        <div class="col-md-3">
                                        ...
                                        <label for="localJPOnOff" class="col-md-2 control-label"><?php echo e(__ ("authenticated.Local JP")); ?>:</label>
                                        <div class="col-md-3">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        <label for="toHours" class="col-md-6 control-label"><?php echo e(__ ("authenticated.JackPot possible to win (to hours)")); ?>:</label>
                                        <div class="col-md-6">
                                            <input min="0" class="form-control" placeholder="<?php echo e(__ ("authenticated.JackPot possible to win (to hours)")); ?>" name="toHours" type="number" id="toHours">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="box box-primary">
                                        <div class="box-header">
                                            <h3 class="box-title"><?php echo e(__ ("authenticated.Levels Win")); ?></h3>
                                        </div>
                                        <div class="box-body">
                                            <div class="row" id="labelsRow">
                                                <div class="col-md-3 col-sm-3 col-xs-12" align="center">
                                                    <label for="winPrice" class="control-label labelSmall"><?php echo e(__ ("authenticated.Win Price")); ?><strong style="color: red">*</strong></label>
                                                </div>
                                                <div class="col-md-3 col-sm-3 col-xs-12 required" align="center">
                                                    <label for="winProbability" class="control-label labelSmall"><?php echo e(__ ("authenticated.Win Probability")); ?><strong style="color: red">*</strong></label>
                                                </div>
                                                <div class="col-md-3 col-sm-3 col-xs-12" align="center">
                                                    <label for="winProbability" class="control-label labelSmall"><?php echo e(__ ("authenticated.Win Before")); ?></label>
                                                </div>
                                                <div class="col-md-3 col-sm-3 col-xs-12 required" align="center">
                                                    <label for="winProbability" class="control-label labelSmall"><?php echo e(__ ("authenticated.Min Bet To Win JP")); ?><strong style="color: red">*</strong></label>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-group">
                                                        <label for="winPriceGlobal" class="col-md-4 control-label labelSmall"><?php echo e(__ ("authenticated.Global")); ?>:</label>
                                                        <div class="col-md-8">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-group">
                                                        <label for="winPriceLocal" class="col-md-4 control-label labelSmall"><?php echo e(__ ("authenticated.Local")); ?>:</label>
                                                        <div class="col-md-8">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3 col-sm-3 col-xs-12">
                                                    <label for="winWholePot" class="control-label labelSmall"><?php echo e(__ ("authenticated.Win Whole Pot")); ?>:</label>
                                                    <select class="form-control" id="winWholePot" name="winWholePot">
                                                        <option value="1"><?php echo e(__ ("authenticated.Yes")); ?></option>
                                                        <option value="-1"><?php echo e(__ ("authenticated.No")); ?></option>
                                                    </select>
                                                </div>
                                                <div class="col-md-3 col-sm-3 col-xs-12">
                                                </div>
                                                <div class="col-md-3 col-sm-3 col-xs-12">
                                                    <label for="winWholePot" class="control-label labelSmall"><?php echo e(__ ("authenticated.JackPot Will trigger before this amount")); ?></label>
                                                </div>
                                                <div class="col-md-3 col-sm-3 col-xs-12">
                                                    <label for="winWholePot" class="control-label labelSmall"><?php echo e(__ ("authenticated.Min Bet is total bet per ticket")); ?></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="box box-primary">
                                        <div class="box-header">
                                            <h3 class="box-title"><?php echo e(__ ("authenticated.Levels JP Pot")); ?></h3>
                                        </div>
                                        <div class="box-body">
                                            <div class="row" id="labelsRow2">
                                                <div class="col-md-6 col-sm-6 col-xs-12" align="center">
                                                    <label for="winPrice" class="control-label labelSmall"><?php echo e(__ ("authenticated.From Bet To JP POT")); ?><strong style="color: red">*</strong></label>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-xs-12" align="center">
                                                    <label for="winPrice" class="control-label labelSmall"><?php echo e(__ ("authenticated.JP Pot Start Value")); ?><strong style="color: red">*</strong></label>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <?php elseif($agent->isMobile()): ?>
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group required">
                                        <label for="globalJPOnOff" class="col-md-4 control-label"><?php echo e(__ ("authenticated.Global JP")); ?>:</label>
                                        <div class="col-md-6">
                                            <select class="form-control" id="globalJPOnOff">
                                                <option value="-1"><?php echo e(trans("authenticated.Off")); ?></option>
                                                <option value="1"><?php echo e(trans("authenticated.On")); ?></option>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group required">
                                        <label for="localJPOnOff" class="col-md-4 control-label"><?php echo e(__ ("authenticated.Local JP")); ?>:</label>
                                        <div class="col-md-6">
                                            <select class="form-control" id="localJPOnOff">
                                                <option value="-1"><?php echo e(trans("authenticated.Off")); ?></option>
                                                <option value="1"><?php echo e(trans("authenticated.On")); ?></option>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="box box-primary">
                                        ...
                                        <div class="box-body">
                                            <!--<div class="row" id="labelsRow">
                                                <div class="col-md-3 col-sm-3 col-xs-12" align="center">
                                                    <label for="winPrice" class="control-label labelSmall"><?php echo e(__ ("authenticated.Win Price")); ?></label>
                                                </div>
                                                <div class="col-md-3 col-sm-3 col-xs-12" align="center">
                                                    <label for="winProbability" class="control-label labelSmall"><?php echo e(__ ("authenticated.Win Probability")); ?></label>
                                                </div>
                                                <div class="col-md-3 col-sm-3 col-xs-12" align="center">
                                                    <label for="winProbability" class="control-label labelSmall"><?php echo e(__ ("authenticated.Win Before")); ?></label>
                                                </div>
                                                <div class="col-md-3 col-sm-3 col-xs-12" align="center">
                                                    <label for="winProbability" class="control-label labelSmall"><?php echo e(__ ("authenticated.Min Bet To Win JP")); ?></label>
                                                </div>
                                            </div>-->
                                            <div class="row">
                                                <div class="col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-group required">
                                                        <label for="winPriceGlobal" class="col-md-4 control-label"><?php echo e(__ ("authenticated.Global Win Price")); ?>:</label>
                                                        <div class="col-md-8">
                                                            <input min="0" class="form-control" name="winPriceGlobal" type="number" id="winPriceGlobal">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-group required">
                                                        <label for="winProbabilityGlobal" class="col-md-1 control-label"><?php echo e(__ ("authenticated.Global Win Probability")); ?> 1:</label>
                                                        <div class="col-md-8">
                                                            <input min="0" class="form-control" name="winProbabilityGlobal" type="number" id="winProbabilityGlobal">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-group">
                                                        <label for="winBeforeGlobal" class="col-md-1 control-label"><?php echo e(__ ("authenticated.Global Win Before")); ?></label>
                                                        <div class="col-md-12">
                                                            <input min="0" class="form-control" name="winBeforeGlobal" type="number" id="winBeforeGlobal">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-group required">
                                                        <label for="minBetToWinGlobal" class="col-md-1 control-label"><?php echo e(__ ("authenticated.Global Min. Bet To Win JP")); ?>:</label>
                                                        <div class="">
                                                            <input min="0" class="form-control" name="minBetToWinGlobal" type="number" id="minBetToWinGlobal">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-group required">
                                                        <label for="winPriceLocal" class="col-md-4 control-label"><?php echo e(__ ("authenticated.Local Win Price")); ?>:</label>
                                                        <div class="col-md-8">
                                                            <input min="0" class="form-control" name="winPriceLocal" type="number" id="winPriceLocal">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-group required">
                                                        <label for="winProbabilityLocal" class="col-md-1 control-label"><?php echo e(__ ("authenticated.Local Win Probability")); ?> 1:</label>
                                                        <div class="col-md-8">
                                                            <input min="0" class="form-control" name="winProbabilityLocal" type="number" id="winProbabilityLocal">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-group">
                                                        <label for="winBeforeLocal" class="col-md-1 control-label"><?php echo e(__ ("authenticated.Local Win Before")); ?></label>
                                                        <div class="col-md-12">
                                                            <input min="0" class="form-control" name="winBeforeLocal" type="number" id="winBeforeLocal">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-group required">
                                                        <label for="minBetToWinLocal" class="col-md-1 control-label"><?php echo e(__ ("authenticated.Local Min. Bet To Win JP")); ?></label>
                                                        <div class="">
                                                            <input min="0" class="form-control" name="minBetToWinLocal" type="number" id="minBetToWinLocal">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3 col-sm-3 col-xs-12 required">
                                                    <label for="winWholePot" class="control-label"><?php echo e(__ ("authenticated.Win Whole Pot")); ?>:</label>
                                                    <select class="form-control" id="winWholePot" name="winWholePot">
                                                        <option value="1"><?php echo e(__ ("authenticated.Yes")); ?></option>
                                                        <option value="-1"><?php echo e(__ ("authenticated.No")); ?></option>
                                                    </select>
                                                ...
                                                <div class="col-md-3 col-sm-3 col-xs-12">
                                                    <br>
                                                    <label for="winWholePot" class="control-label labelSmall">*<?php echo e(__ ("authenticated.JackPot will trigger before 'Win Before' amount.")); ?></label>
                                                </div>
                                                <div class="col-md-3 col-sm-3 col-xs-12">
                                                    <label for="winWholePot" class="control-label labelSmall">*<?php echo e(__ ("authenticated.Min Bet is total bet per ticket.")); ?></label>
                                                </div>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="box box-primary">
                                        ...
                                        <div class="box-body">
                                            <!--<div class="row" id="labelsRow2">
                                                <div class="col-md-6 col-sm-6 col-xs-12" align="center">
                                                    <label for="winPrice" class="control-label labelSmall"><?php echo e(__ ("authenticated.From Bet To JP POT")); ?></label>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-xs-12" align="center">
                                                    <label for="winPrice" class="control-label labelSmall"><?php echo e(__ ("authenticated.JP Pot Start Value")); ?></label>
                                                </div>
                                            </div>-->
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="form-group required">
                                                        <label for="fromBetToJPGlobal" class="control-label"><?php echo e(__ ("authenticated.Global From Bet To JP POT")); ?>:</label>
                                                        <div class="input-group">
                                                            <input min="0" class="form-control" name="fromBetToJPGlobal" type="number" id="fromBetToJPGlobal">
                                                            <span class="input-group-addon">%</span>
                                                        </div>
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="form-group required">
                                                        <label for="jpStartValueGlobal" class="control-label"><?php echo e(__ ("authenticated.Global JP Pot Start Value")); ?>:</label>
                                                        <div class="col-md-12">
                                                            <input min="0" class="form-control" name="jpStartValueGlobal" type="number" id="jpStartValueGlobal">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="form-group required">
                                                        <label for="fromBetToJPLocal" class="control-label"><?php echo e(__ ("authenticated.Local From Bet To JP POT")); ?>:</label>
                                                        <div class="input-group">
                                                            <input min="0" class="form-control" name="fromBetToJPLocal" type="number" id="fromBetToJPLocal">
                                                            <span class="input-group-addon">%</span>
                                                        </div>
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="form-group required">
                                                        <label for="jpStartValueLocal" class="control-label"><?php echo e(__ ("authenticated.Local JP Pot Start Value")); ?>:</label>
                                                        <div class="col-md-12">
                                                            <input min="0" class="form-control" name="jpStartValueLocal" type="number" id="jpStartValueLocal">
                                                        </div>
                                                    </div>
                        ...
                        <div class="form-actions">
                            <button class="btn btn-primary" type="button" name="save" id="addNewJPBtn"><i class="fa fa-save">&nbsp;</i><?php echo e(__ ("authenticated.Add")); ?></button>
                            <button class="btn btn-default" type="button" name="cancel" id="cancelNewJPBtn"><i class="fa fa-times">&nbsp;</i><?php echo e(__ ("authenticated.Cancel")); ?></button>
                        </div>
                    </form>
                </div>
            </div>
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><?php echo e(__ ("authenticated.JackPot Model List")); ?></h3>
                </div>
                <div class="box-body">
                    <table id="modelList" class="table table-bordered dataTable pull-left" style="width: 100% !important;">
                        <thead>
                        <tr class="bg-blue-active">
                            <th><?php echo e(__ ("authenticated.Model Name")); ?></th>
                            <th><?php echo e(__ ("authenticated.Currency")); ?></th>
                            <th>Details L G</th>
                            <th style="text-align: left;"><?php echo e(__ ("authenticated.Action")); ?></th>
                        </thead>
                    </table>
                </div>
            </div>
            ...
            <div class="box" id="selectedModelSubjectsListBox" style="display:none;">
                <div class="box-header">
                    <h3 class="box-title"><?php echo e(__ ("List of Subjects for Selected JP Model")); ?>&nbsp;(<strong id="selectedModelName"></strong>)</h3>
                </div>
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-5">
                        ...
                        <div class="col-md-6">
                            ...
                            <table id="enabledSubjectsList" class="table table-bordered dataTable smallFont pull-left" style="width: 100%;">
                                ...
                                <tr class="bg-blue-active">
                                    <th><?php echo e(__ ("Name")); ?></th>
                                    <th><?php echo e(__ ("Type")); ?></th>
                                    <th style="text-align: left;"><?php echo e(__ ("Priority")); ?></th>
                                    <th><?php echo e(__ ("Activity Type")); ?></th>
                                    <th><?php echo e(__ ("Pot")); ?></th>
                                    <th style="text-align: left;"><?php echo e(__ ("Details")); ?></th>
                                </tr>
                                </thead>
                            </table>
                        </div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><?php echo e(__ ("Edit JP Model")); ?></h4>
                </div>
                    ...
                    <div class="box animate fadeOut" id="newJpModelBox">
                        <div class="box-body">
                            <form id="editJackpotModelForm" class="form-horizontal">
                                ...
                                <?php if($agent->isDesktop()): ?>
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group required">
                                                <label for="nameEdit" class="col-md-4 control-label"><?php echo e(__ ("authenticated.Name")); ?>:</label>
                                                <div class="col-md-6">
                                                    <input class="form-control" placeholder="<?php echo e(__ ("authenticated.Name")); ?>" name="nameEdit" type="text" id="nameEdit">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label for="minNoOfTicketsEdit" class="col-md-6 control-label"><?php echo e(__ ("authenticated.Min no. of tickets in draw to win")); ?>:</label>
                                                <div class="col-md-6">
                                                    <input step="0.01" min="0" class="form-control" placeholder="<?php echo e(__ ("authenticated.Min no. of tickets in draw to win")); ?>" name="minNoOfTicketsEdit" type="number" id="minNoOfTicketsEdit">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group required">
                                                <label for="currencyEdit" class="col-md-4 control-label"><?php echo e(__ ("authenticated.Currency")); ?>:</label>
                                                <div class="col-md-6">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label for="fromHoursEdit" class="col-md-6 control-label"><?php echo e(__ ("authenticated.JackPot possible to win (from hours)")); ?>:</label>
                                                <div class="col-md-6">
                                                    <input min="0" class="form-control" placeholder="<?php echo e(__ ("authenticated.JackPot possible to win (from hours)")); ?>" name="fromHoursEdit" type="number" id="fromHoursEdit">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group required">
                                                <label for="globalJPOnOffEdit" class="col-md-2 control-label"><?php echo e(__ ("authenticated.Global JP")); ?>:</label>
                                                <div class="col-md-3">
                                                ...
                                                <label for="localJPOnOffEdit" class="col-md-2 control-label"><?php echo e(__ ("authenticated.Local JP")); ?>:</label>
                                                <div class="col-md-3">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label for="toHoursEdit" class="col-md-6 control-label"><?php echo e(__ ("authenticated.JackPot possible to win (to hours)")); ?>:</label>
                                                <div class="col-md-6">
                                                    <input min="0" class="form-control" placeholder="<?php echo e(__ ("authenticated.JackPot possible to win (to hours)")); ?>" name="toHoursEdit" type="number" id="toHoursEdit">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                                            <div class="form-group">
                                                                <label for="winPriceGlobalEdit" class="col-md-4 control-label labelSmall"><?php echo e(__ ("authenticated.Global")); ?>:</label>
                                                                <div class="col-md-8">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                                            <div class="form-group">
                                                                <label for="winPriceLocalEdit" class="col-md-4 control-label labelSmall"><?php echo e(__ ("authenticated.Local")); ?>:</label>
                                                                <div class="col-md-8">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                                            <label for="winWholePotEdit" class="control-label labelSmall"><?php echo e(__ ("authenticated.Win Whole Pot")); ?>:</label>
                                ...
                                <?php elseif($agent->isMobile()): ?>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group required">
                                                <label for="globalJPOnOffEdit" class="col-md-4 control-label"><?php echo e(__ ("authenticated.Global JP")); ?>:</label>
                                                <div class="col-md-6">
                                                    <select class="form-control" id="globalJPOnOffEdit">
                                                        <option value="-1"><?php echo e(trans("authenticated.Off")); ?></option>
                                                        <option value="1"><?php echo e(trans("authenticated.On")); ?></option>
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group required">
                                                <label for="localJPOnOffEdit" class="col-md-4 control-label"><?php echo e(__ ("authenticated.Local JP")); ?>:</label>
                                                <div class="col-md-6">
                                                    <select class="form-control" id="localJPOnOffEdit">
                                                        <option value="-1"><?php echo e(trans("authenticated.Off")); ?></option>
                                                        <option value="1"><?php echo e(trans("authenticated.On")); ?></option>
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                                            <div class="form-group required">
                                                                <label for="winPriceGlobalEdit" class="col-md-4 control-label"><?php echo e(__ ("authenticated.Global Win Price")); ?>:</label>
                                                                <div class="col-md-8">
                                                                    <input min="0" class="form-control" name="winPriceGlobalEdit" type="number" id="winPriceGlobalEdit">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                                            <div class="form-group required">
                                                                <label for="winProbabilityGlobalEdit" class="col-md-1 control-label"><?php echo e(__ ("authenticated.Global Win Probability")); ?> 1:</label>
                                                                <div class="col-md-8">
                                                                    <input min="0" class="form-control" name="winProbabilityGlobalEdit" type="number" id="winProbabilityGlobalEdit">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                                            <div class="form-group">
                                                                <label for="winBeforeGlobalEdit" class="col-md-1 control-label"><?php echo e(__ ("authenticated.Global Win Before")); ?>:</label>
                                                                <div class="col-md-12">
                                                                    <input min="0" class="form-control" name="winBeforeGlobalEdit" type="number" id="winBeforeGlobalEdit">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                                            <div class="form-group required">
                                                                <label for="minBetToWinGlobalEdit" class="col-md-1 control-label"><?php echo e(__ ("authenticated.Global Min. Bet To Win JP")); ?></label>
                                                                <div class="">
                                                                    <input min="0" class="form-control" name="minBetToWinGlobalEdit" type="number" id="minBetToWinGlobalEdit">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                                            <div class="form-group required">
                                                                <label for="winPriceLocalEdit" class="col-md-4 control-label"><?php echo e(__ ("authenticated.Local Win Price")); ?>:</label>
                                                                <div class="col-md-8">
                                                                    <input min="0" class="form-control" name="winPriceLocalEdit" type="number" id="winPriceLocalEdit">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                                            <div class="form-group required">
                                                                <label for="winProbabilityLocalEdit" class="col-md-1 control-label"><?php echo e(__ ("authenticated.Local Win Probability")); ?> 1:</label>
                                                                <div class="col-md-8">
                                                                    <input min="0" class="form-control" name="winProbabilityLocalEdit" type="number" id="winProbabilityLocalEdit">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                                            <div class="form-group">
                                                                <label for="winBeforeLocalEdit" class="col-md-1 control-label"><?php echo e(__ ("authenticated.Local Win Before")); ?>:</label>
                                                                <div class="col-md-12">
                                                                    <input min="0" class="form-control" name="winBeforeLocalEdit" type="number" id="winBeforeLocalEdit">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                                            <div class="form-group required">
                                                                <label for="minBetToWinLocalEdit" class="col-md-1 control-label"><?php echo e(__ ("authenticated.Local Min. Bet To Win JP")); ?>:</label>
                                                                <div class="">
                                                                    <input min="0" class="form-control" name="minBetToWinLocalEdit" type="number" id="minBetToWinLocalEdit">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                                            <label for="winWholePotEdit" class="control-label"><?php echo e(__ ("authenticated.Win Whole Pot")); ?>:</label>
                                                            <select class="form-control" id="winWholePotEdit" name="winWholePotEdit">
                                                                <option value="1"><?php echo e(__ ("authenticated.Yes")); ?></option>
                                                                <option value="-1"><?php echo e(__ ("authenticated.No")); ?></option>
                                                            </select>
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group required">
                                                                <label for="fromBetToJPGlobalEdit" class="control-label labelSmall"><?php echo e(__ ("authenticated.Global From Bet To JP POT")); ?>:</label>
                                                                <div class="input-group">
                                                                    <input min="0" class="form-control" name="fromBetToJPGlobalEdit" type="number" id="fromBetToJPGlobalEdit">
                                                                    <span class="input-group-addon">%</span>
                                                                </div>
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <div class="form-group required">
                                                                <label for="jpStartValueGlobalEdit" class="control-label labelSmall"><?php echo e(__ ("authenticated.Global JP Pot Start Value")); ?>:</label>
                                                                <div class="col-md-12">
                                                                    <input min="0" class="form-control" name="jpStartValueGlobalEdit" type="number" id="jpStartValueGlobalEdit">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <div class="form-group required">
                                                                <label for="fromBetToJPLocalEdit" class="control-label labelSmall"><?php echo e(__ ("authenticated.Local From Bet To JP POT")); ?>:</label>
                                                                <div class="input-group">
                                                                    <input min="0" class="form-control" name="fromBetToJPLocalEdit" type="number" id="fromBetToJPLocalEdit">
                                                                    <span class="input-group-addon">%</span>
                                                                </div>
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <div class="form-group required">
                                                                <label for="jpStartValueLocalEdit" class="control-label labelSmall"><?php echo e(__ ("authenticated.Local JP Pot Start Value")); ?>:</label>
                                                                <div class="col-md-12">
                                                                    <input min="0" class="form-control" name="jpStartValueLocalEdit" type="number" id="jpStartValueLocalEdit">
                                                                </div>
                                                            </div>
                            ...
                            <div id="alertWarningEditModel" class="alert alert-warning" style="display:none;">
                                ...
                                <?php echo e(trans("authenticated.If you disable a specific jackpot for this model, all affiliates with this model WILL have this specific jackpot disabled.")); ?>

                                <br>
                                <?php echo e(trans("authenticated.If you enable a specific jackpot for this model, all affiliates with this model WILL NOT have this specific jackpot enabled, it must be done manually.")); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="alertInfoLocationEditJPModal" class="alert alert-warning" style="display: none;">
                        <span class="fa fa-warning">&nbsp;</span><?php echo e(trans("authenticated.This location has no affiliate to inherit global jack-pot from, therefore, global jack-pot can not be active.")); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select disabled name="location_priority_level" id="location_priority_level" class="form-control">
                                    <option value="<?php echo e(config("constants.priority_100")); ?>">100%</option>
                                    <option value="<?php echo e(config("constants.priority_50")); ?>">50%</option>
                                    <option value="<?php echo e(config("constants.priority_0")); ?>">0%</option>
                                </select>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            var client_type_id = "<?php echo e(config('constants.CLIENT_TYPE_ID')); ?>";
            var operator_type_id = "<?php echo e(config('constants.OPERATER_TYPE_ID')); ?>";
            var location_type_id = "<?php echo e(config('constants.LOCATION_TYPE_ID')); ?>";
            ...
            var table = $('#modelList').DataTable( {
                ...
                ajax: {
                    method: "GET",
                    url: "<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "getJpModels")); ?>",
                    "dataSrc": "result"
                },
                "paging": true,
            ...
            function generateSubjectTables(model_id){
                ...
                tableDisabledSubjects = $('#disabledSubjectsList').DataTable( {
                    ...
                    ajax: {
                        method: "GET",
                        url: "<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "getDisabledSubjectsForJPModel")); ?>",
                        data:{
                            model_id: model_id
                        },
                        "dataSrc": "result"
                ...
                tableEnabledSubjects = $('#enabledSubjectsList').DataTable( {
                    ...
                    ajax: {
                        method: "GET",
                        url: "<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "getEnabledSubjectsForJPModel")); ?>",
                        data:{
                            model_id: model_id
                        },
                        "dataSrc": "result"
                    ...
                    columns:[
                        ...
                        },
                        {
                            data: function(row, type, val, meta){
                                ...
                                if(subject_type_id == "<?php echo e(config('constants.LOCATION_TYPE_ID')); ?>"){
            ...
            function getAffJPModelSettings(subject_id){
                $.ajax({
                    method: "GET",
                    url: "<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "getAffJPModelSettings")); ?>",
                    dataType: "json",
                    data: {
            ...
            function deleteJPModel(model_id){
                $.ajax({
                    method: "GET",
                    url: "<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "deleteJPModel")); ?>",
                    dataType: "json",
                    data: {
                        model_id: model_id
                    },
            ...
            function listInheritFromSubjects(subject_id, model_id){
                $.ajax({
                    method: "GET",
                    url: "<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "listSubjectsForGlobalJP")); ?>",
                    dataType: "json",
                    data: {
                        subject_id: subject_id,
                        model_id: model_id
            ...
            function saveJPModelDetailsClient(subject_id, model_id, priority, local_level_on_off, global_level_on_off, current_amount, inherited_from){
                $.ajax({
                    method: "GET",
                    url: "<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "updateJPModelDetailsForAffiliate")); ?>",
                    dataType: "json",
                    data: {
                        subject_id: subject_id,
                        model_id: model_id,
            ...
            function updateJPModel(model_id, model_name, currency, minNoTickets, fromHours, toHours, winPriceLocal, winPriceGlobal, winProbabilityLocal,
                ...
                $.ajax({
                    method: "GET",
                    url: "<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "updateJPModel")); ?>",
                    dataType: "json",
                    data: {
                        model_id: model_id,
            ...
            startValueLocal, startValueGlobal, global_on_off, local_on_off){
                $.ajax({
                    method: "GET",
                    url: "<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "createNewJPModel")); ?>",
                    dataType: "json",
                    data: {
                        model_name: model_name,
                        currency: currency,
            ...
            function getJpModelDetails(model_id){
                $.ajax({
                    method: "GET",
                    url: "<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "getJPModelDetails")); ?>",
                    dataType: "json",
                    data: {
                        model_id: model_id
                    },
            ...
            function disableJpModelForSubject(subject_id){
                $.ajax({
                    method: "GET",
                    url: "<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "deleteJpModelForSubject")); ?>",
                    dataType: "json",
                    data: {
                        subject_id: subject_id
                    },
            ...
            function enableJpModelForSubject(subject_id, model_id, inherited_from, priority, local_level_on_off, global_level_on_off, payout_percent, subject_type_id){
                $.ajax({
                    method: "GET",
                    url: "<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "addJpModelForSubject")); ?>",
                    dataType: "json",
                    data: {
                        subject_id: subject_id,
                        model_id: model_id,
