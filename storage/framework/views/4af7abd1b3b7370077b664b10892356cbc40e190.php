...
<script type="text/javascript">
	function calculateWidths(){
		var tableWidth = [];
		$("#search-users > thead > tr.bg-blue-active > th").each(function(index, value) {
			tableWidth.push(value.width);
		});

		$("#search-users > tbody > tr").each(function(index, value){
...
$(document).ready(function() {
    ...
    var table = $('#search-users').DataTable(
        {
            initComplete: function (settings, json) {
                $("#search-users_length").addClass("pull-right");
                $("#search-users_filter").addClass("pull-left");
            },
            scrollX: true,
            scrollY: "50vh",
            "order": [],
    ...
    document.getElementById('search-users_wrapper').removeChild(
        document.getElementById('search-users_wrapper').childNodes[0]
    );
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select name="subject_type" id="subject_type" class="form-control">
                                        ...
                                        <?php $__currentLoopData = $list_subject_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option <?php if($subject_type == $item->subject_type_id) { echo "selected='selected'"; } ?> value="<?php echo e($item->subject_type_id); ?>"><?php echo e($item->subject_type_name); ?></option>
				...
				<hr>
				<div class="">
	                <table style="width: 100%;" id="search-users" class="table table-bordered table-hover table-striped pull-left">
	                    <thead>
	                        <tr class="bg-blue-active">
	                            ...
	                            <th width="150"><?php echo e(__("authenticated.Registration Date")); ?></th>
	                            <th width="100"><?php echo e(__("authenticated.Registered By")); ?></th>
								...
								<th width="100"><?php echo e(__("authenticated.Country Name")); ?></th>
								<th width="100"><?php echo e(__("authenticated.Mobile Phone")); ?></th>
	                    ...
	                    <tbody>
	                        ...
	                        <tr>
								...
								<td width="150" class="align-left" title="<?php echo e(__("authenticated.Registration Date")); ?>">
	                                <?php echo e(DateTimeHelper::returnDateFormatted($user->registration_date)); ?>

	                            </td>
								<td width="150" class="align-left" title="<?php echo e(__("authenticated.Registered By")); ?>">
								...
								<td width="100" class="align-left" title="<?php echo e(__("authenticated.Country Name")); ?>">
	                                <?php echo e($user->country_name); ?>

	                            </td>
								<td width="100" class="align-left" title="<?php echo e(__("authenticated.Mobile Phone")); ?>">
