...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            ...
            <?php echo e(__("authenticated.Search All Entities & Users")); ?>            &nbsp;
        </h1>
        <ol class="breadcrumb">
            <li><i class="fa fa-search"></i> <?php echo e(__("authenticated.Administration")); ?></li>
            <li class="active">
                <a href="<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/administration/search-users")); ?>" class="noblockui">
                    <?php echo e(__("authenticated.Search All Entities & Users")); ?>
    ...
    <section class="content">
        ...
        <div class="box">
            <?php echo Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), 'administration/search-users'), 'method'=>'POST',
            'class' => 'row-border' ]); ?>
	                ...
	                <table style="width: 100%" id="administration-search-users" class="table table-bordered table-hover table-striped pull-left">
	                    <thead>
	                        <tr class="bg-blue-active">
	                            ...
	                            <th width="120"><?php echo e(__("authenticated.Parent Name")); ?></th>
	                            ...
	                            <th width="140"><?php echo e(__("authenticated.Registration Date")); ?></th>
	                            <th width="110"><?php echo e(__("authenticated.Registered By")); ?></th>
	                            <th width="60"><?php echo e(__("authenticated.Status")); ?></th>
								...
								<th width="110"><?php echo e(__("authenticated.Country Name")); ?></th>
								<th width="110"><?php echo e(__("authenticated.Mobile Phone")); ?></th>
								<th width="100"><?php echo e(__("authenticated.Post Code")); ?></th>
	                        </tr>
	                    </thead>
	                    <tbody>
	                        ...
	                        <tr>
	                            <td width="100" class="align-left" title="<?php echo e(__("authenticated.Username")); ?>">
                                  <?php echo $__env->make('layouts.shared.structure_entity_controller_account_details_link',
								...
								<td width="150" class="align-left" title="<?php echo e(__("authenticated.Role")); ?>">
                                    <?php echo $__env->make('layouts.shared.user_role',
								...
								<td width="140" class="align-left" title="<?php echo e(__("authenticated.Registration Date")); ?>">
	                                <?php echo e(DateTimeHelper::returnDateFormatted($user->registration_date)); ?>

	                            </td>
								<td width="110" class="align-left" title="<?php echo e(__("authenticated.Registered By")); ?>">
	                                <?php echo e($user->registered_by); ?>

	                            </td>
								<td width="60" class="align-center" title="<?php echo e(__("authenticated.Account Status")); ?>">
                                  <a href="<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/administration/change-user-account-status/user_id/{$user->subject_id}")); ?>" title="<?php echo e(__("authenticated.Change Account Status")); ?>">
										<?php echo $__env->make('layouts.shared.account_status',
											["account_status" => $user->subject_state]
										, array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                  </a>
	                            </td>
								<td width="100" class="align-left" title="<?php echo e(__("authenticated.Language")); ?>">
	                                <?php echo $__env->make('layouts.shared.language',
                                      ["language" => $user->language]
                                      , array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	                            </td>
								<td width="100" class="align-left" title="<?php echo e(__("authenticated.Email")); ?>">
	                                <?php echo e($user->email); ?>

	                            </td>
								<td width="100" class="align-left" title="<?php echo e(__("authenticated.Address")); ?>">
	                                <?php echo e($user->address); ?>

	                            </td>
								<td width="150" class="align-left" title="<?php echo e(__("authenticated.Commercial Address")); ?>">
	                                <?php echo e($user->commercial_address); ?>

	                            </td>
								<td width="100" class="align-left" title="<?php echo e(__("authenticated.City")); ?>">
	                                <?php echo e($user->city); ?>

	                            </td>
								<td width="110" class="align-left" title="<?php echo e(__("authenticated.Country Name")); ?>">
	                                <?php echo e($user->country_name); ?>

	                            </td>
								<td width="110" class="align-left" title="<?php echo e(__("authenticated.Mobile Phone")); ?>">
	                                <?php echo e($user->mobile_phone); ?>

	                            </td>
								<td width="100" class="align-left" title="<?php echo e(__("authenticated.Post Code")); ?>">
