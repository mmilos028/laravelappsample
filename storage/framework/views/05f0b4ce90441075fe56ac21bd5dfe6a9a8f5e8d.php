    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                ...
                <?php echo e(__("authenticated.List Deactivated Terminals")); ?>

            </h1>
            <ol class="breadcrumb">
                <li><i class="fa fa-bar-chart"></i> <?php echo e(__("authenticated.Users")); ?></li>
                <li class="active"><?php echo e(__("authenticated.List Deactivated Terminals")); ?></li>
            </ol>
        </section>
                ...
                <div class="box-header">
                    <div class="row">
                        <div class="col-md-11 col-xs-8">
                            ...
                            <?php echo Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), 'terminal/list-deactivated-terminals-excel'), 'method'=>'POST', 'class' => 'form-horizontal row-border' ]); ?>

                            <button class="btn btn-sm btn-primary pull-right" data-toggle="tooltip" data-placement="top" title="<?php echo e(__("authenticated.Export To Excel")); ?>">
                        ...
                        <div class="col-md-12">
                            <table id="report" class="table table-bordered dataTable pull-left" style="width: 100%; font-size: 11px !important;">
                                ...
                                <tr id="tableHeader" class="bg-blue-active headerFontXL">
                                    ...
                                    <th style="text-align: left;"><?php echo e(__ ("authenticated.User Type")); ?></th>
                                    <th style="text-align: left;"><?php echo e(__ ("authenticated.Registration Date")); ?></th>
                                </thead>
                            </table>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            financialReportTable = $('#report').DataTable( {
                ...
                ajax: {
                    method: "GET",
                    url: "<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "listDisconnectedTerminals")); ?>",
                    "dataSrc": "result"
                },
                "paging": true,
