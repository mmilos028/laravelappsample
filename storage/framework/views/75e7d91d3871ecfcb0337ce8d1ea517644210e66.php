...
<?php elseif($account_role_name == config('constants.ROLE_LOCATION')): ?>
<a class="underline-text bold-text"
  href="<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/user/details/user_id/{$account_id}")); ?>"
  title="<?php echo e(__("authenticated.Details")); ?>">
    <?php echo e($account_username); ?>
...
<?php elseif($account_role_name == config('constants.ROLE_CASHIER_TERMINAL')): ?>
<a class="underline-text bold-text"
  href="<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/terminal/details/user_id/{$account_id}")); ?>"
  title="<?php echo e(__("authenticated.Details")); ?>">
    <?php echo e($account_username); ?>
...
<?php elseif($account_role_name == config('constants.ROLE_TERMINAL_TV')): ?>
<a class="underline-text bold-text"
  href="<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/user/details/user_id/{$account_id}")); ?>"
  title="<?php echo e(__("authenticated.Details")); ?>">
    <?php echo e($account_username); ?>
