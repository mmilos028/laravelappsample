...
<?php $__env->startSection('content'); ?>
    ...
    <script type="text/javascript">
        function calculateWidths(){
            var tableWidth = [];
            $("#administration-search-users-small > thead > tr.bg-blue-active > th").each(function(index, value) {
                tableWidth.push(value.width);
            });

            $("#administration-search-users-small > tbody > tr").each(function(index, value){
        ...
        var table = $('#administration-search-users-small').DataTable({
            //"dom": '<"top"fl>rt<"bottom"ip><"clear">',
            initComplete: function (settings, json) {
                $("#administration-search-users-small_length").addClass("pull-right");
                $("#administration-search-users-small_filter").addClass("pull-left");
            },
            scrollX: true,
            scrollY: "50vh",
            "order": [],
        ...
        document.getElementById('administration-search-users-small_wrapper').removeChild(
            document.getElementById('administration-search-users-small_wrapper').childNodes[0]
        );
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <hr>
				<div class="">
	                <table style="width: 100%;" id="administration-search-users-small" class="table table-bordered table-hover table-striped pull-left">
	                    <thead>
	                    ...
	                    <tbody>
	                        ...
	                        <tr>
								...
								<td width="120" class="align-left" title="<?php echo e(__("authenticated.Parent Name")); ?>">
