...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><i class="fa fa-tree"></i> <?php echo e(__("authenticated.Users")); ?></li>
                <li class="active">
                    <a href="<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/listUsersTree")); ?>" title="<?php echo e(__('authenticated.Structure View')); ?>">
                        <?php echo e(__("authenticated.Structure View")); ?>
