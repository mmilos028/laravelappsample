...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            ...
            <?php echo e(__("authenticated.Ticket List")); ?>
        ...
        <div class="box">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <button id="reportReload" class="btn btn-sm btn-primary pull-right" style="margin-top: 25px !important; margin-right: 15px !important;"><span class="fa fa-refresh">&nbsp;</span><?php echo e(trans("authenticated.Reload")); ?></button>
                </div>
            </div>
            <div class="box-header" id="filterContainer">
                <div class="row">
                    <div class="col-md-2">
                        <label for="affiliate" class="control-label"><?php echo e(__('authenticated.Affiliate1')); ?></label>
                        <select class="form-control" id="affiliate" name="affiliate">
                            <option value=""><?php echo e(trans("authenticated.All")); ?></option>
                        </select>
                    </div>
                    <div class="col-md-2">
                        <label for="ticketStatus" class="control-label"><?php echo e(__('authenticated.Ticket Status')); ?></label>
                ...
                <div id="tableContainer">
                    <table style="width: 100%; font-size: 11px !important;" id="ticket-list-report" class="table table-bordered table-hover table-striped pull-left">
                        ...
                        <tr class="bg-blue-active">
                            <th style=""></th>
                            <th style="text-align: left;"><?php echo e(__("authenticated.Location")); ?></th>
                            <th style="text-align: left;"><?php echo e(__("authenticated.Player")); ?></th>
                            <th style="text-align: left;"><?php echo e(__("authenticated.Ticket SN")); ?></th>
                            <th style="text-align: left;"><?php echo e(__("authenticated.Created By")); ?></th>
                            <th style="text-align: left;"><?php echo e(__("authenticated.Created Date & Time")); ?></th>
                            <th style="text-align: left;"><?php echo e(__("authenticated.Ticket Status")); ?></th>
                            <th style="text-align: left;"><?php echo e(__("authenticated.Bet per Draw")); ?></th>
                            <th style="text-align: left;"><?php echo e(__("authenticated.Bet per Ticket")); ?></th>
                            <th style="text-align: left;"><?php echo e(__("authenticated.Possible Win")); ?></th>
                            <th style="text-align: left;"><?php echo e(__("authenticated.Executed Win")); ?></th>
                            <th style="text-align: left;"><?php echo e(__("authenticated.Currency")); ?></th>
                            <th style="text-align: left;"><?php echo e(__("authenticated.Combinations")); ?></th>
                            <th style="text-align: left;"><?php echo e(__("authenticated.Jackpot Code")); ?></th>
                            <th style="text-align: left;"><?php echo e(__("authenticated.Ticket Repeat")); ?></th>
                            <th width="100"><?php echo e(__("authenticated.First Draw SN")); ?></th>
                            <th width="150"><?php echo e(__("authenticated.Draw Date & Time")); ?></th>
                            <th width="100"><?php echo e(__("authenticated.Ticket Details")); ?></th>
                        </tr>
                        </thead>
                    </table>
                </div>
...
<script>
    $(document).ready(function(){
        ...
        function getReportData(){
            ...
            $.ajax({
                method: "GET",
                url: "<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/ticket-list-report")); ?>",
                "dataSrc": "result",
                data: {
        ...
        $('#ticket-list-report').on('click', 'td.details-control', function () {
            ...
            if ( row.child.isShown() ) {
                ...
                nestedTable = $("#test"+tableCounter).DataTable({
                    ...
                    ajax: {
                        method: "GET",
                        url: "<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "ticketDetailsPerDrawAjax")); ?>",
                        data:{
                ...
                columns:[
                    ...
                    },
                    {
                        data: function(row, type, val, meta){
                            ...
                            var output = "<?php echo e(trans('authenticated.Local')); ?>: " + local + "<br>" + "<?php echo e(trans('authenticated.Global')); ?>: " + global;
        ...
        function listTicketStatuses(){
            $.ajax({
                method: "GET",
                url: "<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "ticket-list-statuses")); ?>",
                global: false,
                dataType: "json",
                //data: "result",
                //"dataSrc": "result",
