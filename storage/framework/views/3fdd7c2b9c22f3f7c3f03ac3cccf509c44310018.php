    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><?php echo e(__("authenticated.List Login History")); ?></li>
            </ol>
        </section>
                                ...
                                <div class="row" id="fullReportContainer">
                                    <table id="listLoginHistoryFull" class="table table-bordered dataTable pull-left" style="width: 100%; font-size: 13px !important;">
                                        ...
                                        <tr id="tableHeader" class="bg-blue-active headerFontXL">
                                            <th style="text-align: left;"><?php echo e(__ ("authenticated.Session ID")); ?></th>
                                            <th style="text-align: left;"><?php echo e(__ ("authenticated.Start Date/Time")); ?></th>
                                            <th style="text-align: left;"><?php echo e(__ ("authenticated.End Date/Time")); ?></th>
                                            <th style="text-align: left;"><?php echo e(__ ("authenticated.Duration")); ?></th>
                                            <th style="text-align: left;"><?php echo e(__ ("authenticated.IP")); ?></th>
                                            <th style="text-align: left;"><?php echo e(__ ("authenticated.City")); ?></th>
                                            <th style="text-align: left;"><?php echo e(__ ("authenticated.Country")); ?></th>
                                        </thead>
                                    </table>
                                </div>
                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body bg-info">
                    <p id="modal-body-p">
                        <strong><?php echo e(trans("authenticated.This report shows login session history for selected period.")); ?></strong>
                        <br><br>
    ...
    <script>
        $(document).ready(function(){
            ...
            var tree = $('#tree1').treegrid({
                method: 'GET',
                url: '<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "getSubjectTreeUsers")); ?>',
                //data: "result",
            ...
            function generateReport(selected_subject_id, fromDate, toDate){
                ...
                listLoginHistoryTableFull = $('#listLoginHistoryFull').DataTable( {
                    ...
                    ajax: {
                        method: "GET",
                        url: "<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "listLoginHistory")); ?>",
                        data:{
