...
<div class="row">
    <a class="btn btn-app noblockui" href="<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/player/list-players")); ?>">
        <i class="fa fa-search"></i>
        <?php echo e(__('authenticated.List Players')); ?>

        <span class="sr-only">(current)</span>
    </a>
    <a class="btn btn-app noblockui" href="<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/player/details/user_id/{$user_id}")); ?>">
        <i class="fa fa-info"></i>
        <?php echo e(__('authenticated.Account Details')); ?>

        <span class="sr-only">(current)</span>
    </a>
    <a class="btn btn-app noblockui" href="<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/player/update-player/user_id/{$user_id}")); ?>">
        <i class="fa fa-edit"></i>
        <?php echo e(__('authenticated.Update Player')); ?>

        <span class="sr-only">(current)</span>
    </a>
    <a class="btn btn-app noblockui" href="<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/player/change-password/user_id/{$user_id}")); ?>">
