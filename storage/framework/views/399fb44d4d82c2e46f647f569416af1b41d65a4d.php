    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                ...
                <?php echo e(__("authenticated.Deposit")); ?>                &nbsp;
            </h1>
            <ol class="breadcrumb">
                <li><i class="fa fa-plus"></i> <?php echo e(__("authenticated.Credit Transfers")); ?></li>
                <li class="active">
                    <a href="<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/transfer-credit/deposit-list")); ?>" title="<?php echo e(__('authenticated.Deposit')); ?>">
                        <?php echo e(__("authenticated.Deposit")); ?>
                ...
                <div class="box-body">
                    <table class="table">
                        <tr>
                            ...
                            <td class="pull-right">
                                <?php echo Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), 'transfer-credit/deposit-list'), 'method'=>'POST', 'class' => 'form-horizontal row-border' ]); ?>
                                ...
                                <tr>
                                    <td width="100" title="<?php echo e(__("authenticated.Username")); ?>">
                                        <?php if($subject_type == config('constants.COLLECTOR_TYPE_NAME')): ?>
                                            <a href="<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/transfer-credit/cashier-player-deposit/user_id/{$user->subject_id}")); ?>" class="btn btn-block btn-success">
                                        ...
                                        <?php elseif($subject_type == config('constants.ROLE_CASHIER') || $subject_type == config('constants.SHIFT_CASHIER')): ?>
                                            <a href="<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/transfer-credit/cashier-player-deposit/user_id/{$user->subject_id}")); ?>" class="btn btn-block btn-primary">
                                                <?php echo e($user->username); ?>
                                        ...
                                        <?php elseif($subject_type == config('constants.ROLE_PLAYER')): ?>
                                            ...
                                            <?php else: ?>
                                                <a href="<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/transfer-credit/cashier-player-deposit/user_id/{$user->subject_id}")); ?>" class="btn btn-block btn-info">
                                                    <?php echo e($user->username); ?>
                                    ...
                                    <td width="150" class="align-center" title="<?php echo e(__("authenticated.Status")); ?>">
                                        <?php echo $__env->make('layouts.shared.account_status',
                                          ["account_status" => $user->subject_state]
                                        , array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                    </td>
                                    <td align="center" width="100" title="<?php echo e(__("authenticated.Deposit")); ?>">
                                        <?php if($subject_type == config('constants.COLLECTOR_TYPE_NAME')): ?>
                                            <a href="<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/transfer-credit/cashier-player-deposit/user_id/{$user->subject_id}")); ?>" class="btn btn-success">
                                                <?php echo e(__("authenticated.Deposit")); ?>
                                        ...
                                        <?php elseif($subject_type == config('constants.ADMINISTRATOR_OPERATER')): ?>
                                            ...
                                            <?php endif; ?>
                                        <?php elseif($subject_type == config('constants.ROLE_CASHIER') || $subject_type == config('constants.SHIFT_CASHIER')): ?>
                                            <a href="<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/transfer-credit/cashier-player-deposit/user_id/{$user->subject_id}")); ?>" class="btn btn-primary">
                                                <?php echo e(__("authenticated.Deposit")); ?>
                                        ...
                                        <?php elseif($subject_type == config('constants.ROLE_PLAYER')): ?>
                                            ...
                                            <?php else: ?>
                                                <a href="<?php echo e(LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/transfer-credit/cashier-player-deposit/user_id/{$user->subject_id}")); ?>" class="btn btn-info">
                                                    <?php echo e(__("authenticated.Deposit")); ?>
