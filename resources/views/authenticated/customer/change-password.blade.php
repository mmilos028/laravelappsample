...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/customer/change-password/user_id/{$user['user_id']}") }}" title="{{ __('authenticated.Change Password') }}">
                    {{ __("authenticated.Change Password") }}
                </a>
            </li>
        </ol>
    ...
    <section class="content">
        ...
        <div class="widget box col-md-4">
            ...
            <div class="widget-content">
                {!! Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "customer/change-password/user_id/{$user['user_id']}"), 'method'=>'POST', 'class' => 'form-horizontal row-border' ]) !!}
