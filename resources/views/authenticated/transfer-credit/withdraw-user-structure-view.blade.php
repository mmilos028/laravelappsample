    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/transfer-credit/withdraw-user-structure-view") }}" title="{{ __('authenticated.Withdraw - Structure View') }}">
                        {{ __("authenticated.Withdraw - Structure View") }}
                    </a>
                </li>
            </ol>
    ...
    <script>
        $(document).ready(function(){
            ...
            var tree = $('#tree1').treegrid({
                method: 'GET',
                url: '{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/transfer-credit/withdraw-subject-tree") }}',
                ...
                columns:[[
                    {title: "{{ __("authenticated.Username") }}",field:'name',width:400},
                    {title: "{{ __("authenticated.Role") }}",field:'subject_type_name',width:200},
                    {title: "{{ __("authenticated.Credits") }}", align: 'right', field:'credits_formatted',width:150},
                    {title: "{{ __("authenticated.Currency") }}",field:'currency',width:150},
