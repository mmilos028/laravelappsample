...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <span>
                <a class="btn btn-warning btn-lg pull-right" href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), '/transfer-credit/withdraw-list') }}" title="{{ __('authenticated.Back') }}">
                    ...
                    <div class="box">
                        <div class="box-body">
                            @include('layouts.shared.form_messages')
                                {!! Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), 'transfer-credit/cashier-player-withdraw-completed/user_id/' . $user_id), 'method'=>'POST' ]) !!}
