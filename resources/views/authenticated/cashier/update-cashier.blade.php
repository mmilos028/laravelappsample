...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/cashier/update-cashier/user_id/{$user['user_id']}") }}" title="{{ __('authenticated.Update Cashier') }}">
                    {{ __("authenticated.Update Cashier") }}
                </a>
            </li>
        </ol>
    ...
    <section class="content">
        ...
        <div class="widget box col-md-4">
            <div class="widget-header">
                <h4>
                    <i class="fa fa-user"></i>
                    <span>{{ __("authenticated.Update Cashier") }}</span>
                </h4>
            </div>

            <div class="widget-content">
            {!! Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "cashier/update-cashier/user_id/{$user['user_id']}" ), 'method'=>'POST', 'class' => 'form-horizontal row-border' ]) !!}
                ...
                <div class="form-group required">
                    ...
                    <div class="col-md-4">
                        <input readonly="readonly" class="form-control" placeholder="{{__("authenticated.Role")}}" name="subject_role" type="text" value="{{$user['subject_dtype_bo_name']}}" id="subject_role">
                    </div>
                </div>
