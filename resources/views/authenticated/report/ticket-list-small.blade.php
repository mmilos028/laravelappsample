        ...
        <div class="box">
            <div class="box-body">
                ...
                <div class="table-responsive">
                    <table style="width: <?php echo $main_table_width; ?>px;font-size: 11px !important;" id="ticket-list-report" class="table table-bordered table-striped">
                        <thead>
