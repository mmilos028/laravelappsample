...
@section('content')
    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><i class="fa fa-bar-chart"></i> {{ __("authenticated.Administration") }}</li>
                <li class="active">{{ __("authenticated.All Cashier Terminal Codes") }}</li>
            </ol>
        </section>
                        ...
                        <div class="col-md-12">
                            <table id="report" class="table table-bordered dataTable pull-left" style="width: 100%; font-size: 11px !important;">
                                ...
                                <tr id="tableHeader" class="bg-blue-active headerFontXL">
                                    ...
                                    <th style="text-align: left;">{{__ ("authenticated.Service Code")}}</th>
                                    <th style="text-align: left;">{{__ ("authenticated.Valid Until")}}</th>
                                </thead>
                            </table>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            financialReportTable = $('#report').DataTable( {
                ...
                ajax: {
                    method: "GET",
                    url: "{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "allMachineKeysAndCodesReportAjax") }}",
                    "dataSrc": "result"
                },
                "paging": true,
