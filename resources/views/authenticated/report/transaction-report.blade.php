...
@section('content')
    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">{{ __("authenticated.Profit & Collected") }}</li>
            </ol>
        </section>
                    ...
                    @if($agent->isDesktop())
                        <div class="row">
                            <div class="col-md-1 padding">
                                <button id="reloadTree" class="btn btn-block btn-primary" data-toggle="tooltip" data-placement="top" title="{{ __("authenticated.Reload") }}">
                                    <span class="fa fa-refresh"></span>
                                </button>
                            </div>
                            <div class="col-md-1 padding">
                                <button id="showDirectTreeBtn" class="btn btn-block btn-primary" onclick="collapseNotRoot()" data-toggle="tooltip" data-placement="top" title="{{ __("authenticated.Direct") }}">
                                    <span class="fa fa-home"></span>
                                </button>
                            </div>
                            <div class="col-md-1 padding">
                                <button id="expandTreeBtn" class="btn btn-block btn-primary" onclick="expandAll()" data-toggle="tooltip" data-placement="top" title="{{ __("authenticated.All") }}">
                            ...
                            <div class="col-md-2">
                                <label for="currency" class="control-label">{{__('authenticated.Currency')}}</label>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body bg-info">
                    <p id="modal-body-p">
                        <strong>{{trans("authenticated.This report shows totals for profit (ticket) transactions and collector transactions.")}}</strong>
                        <br><br>
                        {{trans("authenticated.Data is retrieved for selected period and represented as subject tree.")}}
                    </p>
                </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            var currency = "{{session("auth.currency")}}";
            ...
            function listCurrencies(start_date, end_date) {
                $.ajax({
                    method: "GET",
                    url: "{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "listCurrenciesForStartEndDateAjax") }}",
                    dataType: "json",
                    data: {
            ...
            var tree = $('#tree1').treegrid({
                method: 'GET',
                url: '{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "transactionReportAjax") }}?from_date=' + document.getElementById("fromDate").value + '&&to_date=' + document.getElementById("toDate").value + '&&currency=' + currency,
                ...
                columns: [[
                    {
                        title: '{{ __("authenticated.Username") }}',
                        field: 'name',
                        width: "200",
                        id: "usernameColumnHeader"
                    },
                    {
                        title: '{{ __("authenticated.Role") }}',
                    ...
                    {
                        title: '{{ __("authenticated.Profit For Period") }}',
                    ...
                    {
                        title: '{{ __("authenticated.Collected On Entity Level") }}',
                    ...
                    {
                        title: '{{ __("authenticated.Actual Player Liability") }}',
                    ...
                    {
                        title: '{{ __("authenticated.Actual Balance") }}',
                    ...
                    {
                        title: '{{ __("authenticated.Currency") }}',
                        field: 'currency',
                        width: "200",
                        align: "left",
                        id: "currencyHeader"
            ...
            function generateReport() {
                ...
                $('#tree1').treegrid('options').url = '{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "transactionReportAjax") }}?from_date=' + document.getElementById("fromDate").value + '&&to_date=' + document.getElementById("toDate").value + '&&currency=' + document.getElementById("currency").value;
