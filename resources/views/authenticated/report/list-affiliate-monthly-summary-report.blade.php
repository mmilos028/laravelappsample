                    ...
                    <div id="tableContainer">
                        <table style="width: 700px; font-size: 11px !important;" id="draw-list-report" class="table table-bordered table-hover table-striped pull-left">
                            ...
                            <tr class="bg-blue-active">
                                <th style="text-align: left;">{{ __("authenticated.Affiliate Name") }}</th>
                                <th style="text-align: left;">{{ __("authenticated.Currency") }}</th>
                                <th style="text-align: right;">{{ __("authenticated.Cash IN") }}</th>
                                <th style="text-align: right;">{{ __("authenticated.Cash OUT") }}</th>
                                <th style="text-align: right;">{{ __("authenticated.Difference") }}</th>
                            </tr>
                            </thead>
                        </table>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body bg-info">
                    <p id="modal-body-p">
                        <strong>{{trans("authenticated.This report shows profit overview per affiliate for actual month.")}}</strong>
                        <br><br>
                        {{trans("authenticated.Data is retrieved per each affiliate.")}}
                    </p>
                </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            function getReportData(){
                ...
                $.ajax({
                    method: "GET",
                    url: "{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/report/list-affiliate-monthly-summary-report") }}",
                    "dataSrc": "result",
                    data: {
                        page_number: null,
