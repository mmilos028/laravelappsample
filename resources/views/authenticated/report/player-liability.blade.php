    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">{{ __("authenticated.Player Liability") }}</li>
            </ol>
        </section>
                                ...
                                <div class="row" id="compressedReportContainer">
                                    <table id="compressedReport" class="table table-bordered dataTable pull-left" style="width: 100%; font-size: 13px !important;">
                                        ...
                                        <tr id="tableHeader" class="bg-blue-active headerFontXL">
                                            <th style="text-align: left;">{{__ ("authenticated.Username")}}</th>
                                            <th style="text-align: left;">{{__ ("authenticated.First Name")}}</th>
                                            <th style="text-align: left;">{{__ ("authenticated.Last Name")}}</th>
                                            <th style="text-align: left;">{{__ ("authenticated.Actual Balance")}}</th>
                                ...
                                <div class="row" style="display: none;" id="fullReportContainer">
                                    <table id="fullReport" class="table table-bordered dataTable pull-left" style="width: 100%; font-size: 13px !important;">
                                        ...
                                        <tr id="tableHeader" class="bg-blue-active labelXS">
                                            ...
                                            <th style="text-align: left;">{{__ ("authenticated.Actual Balance")}}</th>
                                            <th style="text-align: left;">{{__ ("authenticated.Currency")}}</th>
                                            <th style="text-align: left;">{{__ ("authenticated.Deposits")}}</th>
                                            <th style="text-align: left;">{{__ ("authenticated.Withdraws")}}</th>
                                            <th style="text-align: left;">{{__ ("authenticated.Ticket Total")}}</th>
                                            <th style="text-align: left;">{{__ ("authenticated.Win")}}</th>
                                        </thead>
                                    </table>
                                </div>
                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body bg-info">
                    <p id="modal-body-p">
                        <strong>{{trans("authenticated.This report shows player current totals.")}}</strong>
                        <br><br>
    ...
    <script>
        $(document).ready(function(){
            ...
            var tree = $('#tree1').treegrid({
                method: 'GET',
                url: '{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/report/financial-report-get-subject-tree-users") }}?listType=' + "5",
            ...
            function getReportData(selected_subject_id){
                $.ajax({
                    method: "GET",
                    url: "{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "playerLiabilityAjax") }}",
                    data:{
