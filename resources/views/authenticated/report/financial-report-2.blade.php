    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                ...
                {{ __("authenticated.Profit Transactions") }}&nbsp;<button id="showContextualMessage" class="btn btn-primary"><strong class="fa fa-question-circle"></strong></button>
            </h1>
            <ol class="breadcrumb">
                <li><i class="fa fa-bar-chart"></i> {{ __("authenticated.Reports") }}</li>
                <li class="active">{{ __("authenticated.Profit Transactions") }}</li>
            </ol>
        </section>
                    ...
                    <div class="row">
                        ...
                        @if($agent->isDesktop())
                            <div class="col-md-1" align="right" style="padding-top: 22px;">
                                <button style="display: none;" id="longReport" class="btn btn-primary"><span class="fa fa-expand">&nbsp;</span>{{__('authenticated.Long')}}</button>
                                <button style="display: none;" id="shortReport" class="btn btn-primary"><span class="fa fa-compress">&nbsp;</span>{{__('authenticated.Short')}}</button>
                            </div>
                        @endif
                        @if($agent->isMobile())
                            <br>
                                ...
                                <div class="row" id="compressedReportContainer">
                                    <table id="financialReport" class="table table-bordered dataTable pull-left" style="width: 100%; font-size: 13px !important;">
                                        ...
                                        <tr id="tableHeader" class="bg-blue-active labelXS">
                                            ...
                                            <th style="text-align: left;">{{__ ("authenticated.No. Of Not Paid Out Wins")}}</th>
                                            <th style="text-align: left;">{{__ ("authenticated.Not Paid Out Total")}}</th>
                                ...
                                <div class="row">
                                    <table id="financialReport2" class="table table-bordered dataTable pull-left" style="width: 100%; font-size: 13px !important;">
                                        ...
                                        <tr id="tableHeader2" class="bg-blue-active labelXS">
                                            ...
                                            <th style="text-align: left;">{{__ ("authenticated.Start Balance")}}</th>
                                            <th style="text-align: left;">{{__ ("authenticated.Deposit")}}</th>
                                            <th style="text-align: left;">{{__ ("authenticated.Withdraw")}}</th>
                                            <th style="text-align: left;">{{__ ("authenticated.End Balance")}}</th>
                                            <th style="text-align: left;">{{__ ("authenticated.Currency")}}</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">{{trans("authenticated.Message")}}</h4>
                </div>
                <div class="modal-body">
                    <p id="messageModalMessage"></p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default pull-right" data-dismiss="modal">{{trans("authenticated.Ok")}}</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body bg-info">
                    <p id="modal-body-p">
                        <strong>{{trans("authenticated.This report shows profit transactions ie. ticket related transactions.")}}</strong>
                        <br><br>
                        {{trans("authenticated.Data is retrieved per subject, for selected period, and is displayed in 2 tables. Bottom table represents list of transactions for selected subject and period. Upper table represents total values of transactions for selected subject and period, where the total is divided by days within the selected period.")}}
                    </p>
                </div>
                <div class="modal-footer">
    ...
    <script>
        $(document).ready(function(){
            ...
            function getReportData(selected_subject_id, fromDate, toDate){
                $.ajax({
                    method: "GET",
                    url: "{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "financialReport") }}",
                    data:{
                    ...
                    columns:[
                        {
                            data: function(row, type, val, meta){
                                ...
                                if(date == "total"){
                                    output = "<strong>"+"{{__ ("authenticated.TOTAL")}}"+"</date>"
                                }else{
                                    output = output;
                                }
                                return output;
