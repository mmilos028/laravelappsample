...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box table-responsive">
            {!! Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), 'ticket/check-ticket-details-with-serial-number'), 'method'=>'POST', 'class' => 'form-inline row-border' ]) !!}
            <div class="box-body">
                <table class="table">
                  <tr>
                      <td class="align-right">
                      {!! Form::label('ticket_serial_number', trans('authenticated.Serial Number') . ':', array('class' => 'control-label')) !!}
                      {!!
                          Form::text('ticket_serial_number', $ticket_serial_number,
                              array(
									'autofocus',
                                    'class'=>'form-control',
                                    'placeholder'=>trans('authenticated.Serial Number')
                              )
                          )
                      !!}
						{!!
