...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box table-responsive">
            {!! Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), 'ticket/check-ticket-details-with-ticket-id'), 'method'=>'POST', 'class' => 'form-inline row-border' ]) !!}
            <div class="box-body">
                <table class="table">
                    <tr>
