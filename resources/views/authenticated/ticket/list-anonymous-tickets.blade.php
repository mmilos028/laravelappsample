...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            {{ __("authenticated.List Anonymous Tickets") }}
            &nbsp;
        </h1>
        <ol class="breadcrumb">
            <li><i class="fa fa-list"></i> {{ __("authenticated.Ticket") }}</li>
            <li class="active">{{ __("authenticated.List Anonymous Tickets") }}</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box table-responsive">
            {!! Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), 'ticket/list-anonymous-tickets'), 'method'=>'POST', 'class' => 'form-inline row-border' ]) !!}
            <div class="box-body">
                <table class="table table-bordered table-hover table-striped">
                    <thead>
                        <tr>
                            <td colspan="14" class="align-right">
								{!!
