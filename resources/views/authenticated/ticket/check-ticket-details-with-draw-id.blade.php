...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box table-responsive">
            {!! Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), 'ticket/check-ticket-details-with-draw-id'), 'method'=>'POST', 'class' => 'form-inline row-border' ]) !!}
            <div class="box-body">
                <table class="table table-bordered table-hover table-striped">
                    <thead>
                        <tr>
                            <td colspan="15" class="align-right">
                            {!! Form::label('draw_id', trans('authenticated.Draw ID') . ':', array('class' => 'control-label')) !!}
                            {!!
                                Form::text('draw_id', $draw_id,
                                    array(
										  'autofocus',	
                                          'class'=>'form-control',
