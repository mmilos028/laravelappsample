...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/player/report/list-money-transactions/user_id/{$user_id}") }}" title="{{ __('authenticated.List Money Transactions') }}">
                    {{ __("authenticated.List Money Transactions") }}
                </a>
            </li>
        </ol>
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-body">
                {!! Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), 'player/report/list-money-transactions/user_id/' . $user_id), 'method'=>'POST', 'class' => 'form-inline row-border' ]) !!}
                <table class="table">
                    <tr>
                        <td class="pull-left">                            
                        </td>
