...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
			<li><i class="fa fa-bar-chart"></i> {{ __("authenticated.Players") }}</li>
            <li> 
				<a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/player/list-players") }}" class="noblockui">
				    {{ __("authenticated.List Players") }}
				</a>
			</li>
			<li> 
				<a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/player/details/user_id/{$user_id}") }}" class="noblockui">
            ...
            <li class="active">
                <a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/player/report/list-player-tickets/user_id/{$user_id}") }}" title="{{ __('authenticated.List Player Tickets') }}">
                    {{ __("authenticated.List Player Tickets") }}
                </a>
            </li>
        </ol>
            ...
            <div class="box-body">
                <table class="table">
                    <tr>
                        ...
                        <td class="pull-right">
                        {!! Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), 'player/report/list-player-tickets/user_id/' . $user_id), 'method'=>'POST', 'class' => 'form-horizontal row-border' ]) !!}
                            {!!
                    ...
                    <table style="width: 1290px;" id="list-player-tickets" class="table table-bordered table-hover table-striped pull-left">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="150" class="align-left" title="{{ __("authenticated.Ticket Status") }}">
