...
@section('content')
            ...
            <div class="widget box col-md-4">
                ...
                <div class="widget-content">
                    ...
                    <div class="form-group required">
                        <label for="subject_type" class="col-md-3 control-label">{{__ ("authenticated.Role")}}:</label>
                        <div class="col-md-4">
                    ...
                    <div class="form-group required">
                        <label for="parent_affiliate" class="col-md-3 control-label">{{__ ("authenticated.Parent Entity")}}:</label>
                        <div class="col-md-4">
                    ...
                    <div class="form-group required">
                        <label for="currency" class="col-md-3 control-label">{{__ ("authenticated.Currency")}}:</label>
                        <div class="col-md-4">
                    ...
                    <div class="form-group required" id="draw_model_container">
                        <label for="draw_model" class="col-md-3 control-label">{{__ ("authenticated.Draw Model")}}:</label>
                        <div class="col-md-4">
                    ...
                    <div class="form-group required">
                        <label id="usernameLabel" for="username" class="col-md-3 control-label">{{__ ("authenticated.Username")}}:</label>
                        <div class="col-md-4">
                            <input class="form-control" placeholder="{{__ ("authenticated.Username")}}" name="username" type="text" id="username" autofocus>
                        </div>
                    </div>

                    <div class="form-group required" id="passwordContainer">
                        <label id="passwordLabel" for="password" class="col-md-3 control-label">{{__ ("authenticated.Password")}}:</label>
                        <div class="col-md-4">
                            <input class="form-control" placeholder="{{__ ("authenticated.Password")}}" name="password" type="password" id="password">
                        </div>
                    </div>

                    <div class="form-group required" id="confirm_passwordContainer">
                        <label id="confirm_passwordLabel" for="confirm_password" class="col-md-3 control-label">{{__ ("authenticated.Confirm Password")}}:</label>
                        <div class="col-md-4">
                            <input class="form-control" placeholder="{{__ ("authenticated.Confirm Password")}}" name="confirm_password" type="password" value="" id="confirm_password">
                        </div>
                    </div>

                    <div class="form-group">
                        <label id="first_nameLabel" for="first_name" class="col-md-3 control-label">{{__ ("authenticated.First Name")}}:</label>
                        <div class="col-md-4">
                            <input class="form-control" placeholder="{{__ ("authenticated.First Name")}}" name="first_name" type="text" id="first_name">
                        </div>
                    </div>

                    <div class="form-group" id="last_nameContainer">
                        <label for="last_name" class="col-md-3 control-label">{{__ ("authenticated.Last Name")}}:</label>
                        <div class="col-md-4">
                            <input class="form-control" placeholder="{{__ ("authenticated.Last Name")}}" name="last_name" type="text" id="last_name">
                        </div>
                    </div>

                    <div class="form-group required">
                        <label for="mobile_phone" class="col-md-3 control-label">{{__ ("authenticated.Mobile Phone")}}:</label>
                        <div class="col-md-4">
                            <input class="form-control" placeholder="{{__ ("authenticated.Mobile Phone")}}" name="mobile_phone" type="text" id="mobile_phone">
                        </div>
                    </div>

                    <div class="form-group required">
                        <label for="email" class="col-md-3 control-label">{{__ ("authenticated.Email")}}:</label>
                        <div class="col-md-4">
                            <input class="form-control" placeholder="{{__ ("authenticated.Email")}}" name="email" type="text" id="email">
                        </div>
                    </div>

                    <div id="div_form_group_address" class="form-group">
                        <label for="address" class="col-md-3 control-label">{{__ ("authenticated.Address")}}:</label>
                        <div class="col-md-4">
                            <input class="form-control" placeholder="{{__ ("authenticated.Address")}}" name="address" type="text" id="address">
                        </div>
                    </div>

                    <div id="div_form_group_commercial_address" class="form-group">
                        <label for="commercial_address" class="col-md-3 control-label">{{__ ("authenticated.Address 2")}}:</label>
                        <div class="col-md-4">
                            <input class="form-control" placeholder="{{__ ("authenticated.Address 2")}}" name="commercial_address" type="text" id="commercial_address">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="post_code" class="col-md-3 control-label">{{__ ("authenticated.Post Code")}}:</label>
                        <div class="col-md-4">
                            <input id="post_code" class="form-control" placeholder="{{__ ("authenticated.Post Code")}}" name="post_code" type="text">
                        </div>
                    </div>

                    <div id="div_form_group_city" class="form-group">
                        <label for="city" class="col-md-3 control-label">{{__ ("authenticated.City")}}:</label>
                        <div class="col-md-4">
                            <input class="form-control" placeholder="{{__ ("authenticated.City")}}" name="city" type="text" id="city">
                        </div>
                    </div>

                    <div class="form-group required">
                        <label for="country" class="col-md-3 control-label">{{__ ("authenticated.Country")}}:</label>
                        <div class="col-md-4">
                    ...
                    <div class="form-actions">
                        <button class="btn btn-primary" type="button" name="save" id="saveBtn"><i class="fa fa-save">&nbsp;</i>{{__ ("authenticated.Save")}}</button>
                        <button class="btn btn-default" type="button" name="cancel" id="cancelBtn"><i class="fa fa-times">&nbsp;</i>{{__ ("authenticated.Cancel")}}</button>
                    </div>
    ...
    <script>
        $(document).ready(function(){
            var draw_model_types_array = ["{{config('constants.CLIENT_TYPE_ID')}}", "{{config('constants.OPERATER_TYPE_ID')}}", "{{config('constants.LOCATION_TYPE_ID')}}"];
            ...
            function createNewUser(subject_type, parent_affiliate, username, password, confirm_password, first_name, last_name, mobile_phone, email, address,
                ...
                $.ajax({
                    method: "GET",
                    url: "{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "createNewStructureEntity") }}",
                    dataType: "json",
                    data: {
            ...
            function listSubjectTypes(){
                $.ajax({
                    method: "GET",
                    url: "{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "getSubjectRolesForNewStructureEntityForm") }}",
                    global: false,
                    dataType: "json",
                    //data: "result",
                    //"dataSrc": "result",
            ...
            function listCountries(){
                $.ajax({
                    method: "GET",
                    url: "{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "listCountries2") }}",
                    global: false,
                    dataType: "json",
                    //data: "result",
                    //"dataSrc": "result",
            ...
            function getDrawModel(affiliate_id){
                $.ajax({
                    method: "GET",
                    url: "{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "getDrawModelForAff") }}",
                    global: false,
                    dataType: "json",
                    data: {
                    ...
                    success: function(data){
                        ...
                        if(data.status == "OK"){
                            ...
                            if(count < 1){
                                var element = document.createElement('option');
                                element.value = null;
                                element.textContent = "{{trans('authenticated.No active draw models')}}";
                                ...
                                $.each(data.result, function(index, value){
                                    ...
                                    if(value['draw_under_regulation'] == "{{CONTROL}}"){
                                        control_free = "{{trans('authenticated.Control')}}"+" (" + value['bet_win'] + " %)";
                                    }else{
                                        control_free = "{{trans('authenticated.Free')}}";
                                    }
            ...
            $("#subject_type").on("change", function(){
                ...
                if(subject_type_id == "{{config('constants.SELF_SERVICE_TERMINAL_ID')}}"){
                    $("#usernameLabel").text("{{trans('authenticated.MAC Address')}}");
                    $("#username").attr("placeholder", "{{trans('authenticated.MAC Address')}}");

                    $("#first_nameLabel").text("{{trans('authenticated.Self-service Terminal Name')}}");
                    $("#first_name").attr("placeholder", "{{trans('authenticated.Self-service Terminal Name')}}");

                    $("#passwordContainer").hide();
                    $("#confirm_passwordContainer").hide();
                    $("#last_nameContainer").hide();
                }else{
                    $("#usernameLabel").text("{{trans('authenticated.Username')}}");
                    $("#username").attr("placeholder", "{{trans('authenticated.Username')}}");

                    $("#first_nameLabel").text("{{trans('authenticated.First Name')}}");
                    $("#first_name").attr("placeholder", "{{trans('authenticated.First Name')}}");
