...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            ...
            {{ __("authenticated.New Terminal") }}            &nbsp;
        </h1>
        <ol class="breadcrumb">
            <li><i class="fa fa-user-plus"></i> {{ __("authenticated.Users") }}</li>
            <li class="active">{{ __("authenticated.New Terminal") }}</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="widget box col-md-4">
            <div class="widget-header">
                <h4>
                    <i class="fa fa-user-plus"></i>
                    <span>{{ __("authenticated.New Terminal") }}</span>
                </h4>
            </div>

            <div class="widget-content">
            {!! Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), 'terminal/new-terminal'), 'method'=>'POST', 'class' => 'form-horizontal row-border' ]) !!}
