...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><i class="fa fa-user"></i> {{ __("authenticated.Terminals") }}</li>
            <li>
            ...
            <li class="active">
                <a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/terminal/update-terminal/user_id/{$user['user_id']}") }}" title="{{ __('authenticated.Update Terminal') }}">
                    {{ __("authenticated.Update Terminal") }}
                </a>
            </li>
        </ol>
    ...
    <section class="content">
        ...
        <div class="widget box col-md-4">
            <div class="widget-header">
                <h4>
                    <i class="fa fa-user"></i>
                    <span>{{ __("authenticated.Update Terminal") }}</span>
                </h4>
            </div>

            <div class="widget-content">
            {!! Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "terminal/update-terminal/user_id/{$user['user_id']}" ), 'method'=>'POST', 'class' => 'form-horizontal row-border' ]) !!}
                ...
                <div class="form-group required">
                    ...
                    @if($user_type == config("constants.SELF_SERVICE_TERMINAL"))
                        {!! Form::label('username', trans('authenticated.MAC Address') . ':', array('class' => 'col-md-3 control-label')) !!}
                        <div class="col-md-4">
                            {!!
                            ...
                            {!!
                                Form::text('username', $user['username'],
                                    array(
                                          'readonly',
                                          'class'=>'form-control',
                                          'placeholder'=>trans('authenticated.MAC Address')
                                    )
                                )
                            !!}
                        </div>
                ...
                @if($user_type == config("constants.SELF_SERVICE_TERMINAL"))
                    <div class="form-group ">
                        {!! Form::label('first_name', trans('authenticated.Terminal Name') . ':', array('class' => 'col-md-3 control-label')) !!}
                        <div class="col-md-4">
                            {!!
                                Form::text('first_name', $user['first_name'],
                                    array(
                                          'class'=>'form-control',
                                          'placeholder'=>trans('authenticated.Terminal Name')
                                    )
                                )
                            !!}
                        </div>
