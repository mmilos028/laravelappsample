...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">{{ __("authenticated.List Locations") }}</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box table-responsive">
            {!! Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), 'location/list-locations'), 'method'=>'POST', 'class' => 'form-horizontal row-border' ]) !!}
            <div class="box-body">
                <table class="table">
                    <tr>
                        <td class="pull-right">
                ...
                <table id="list-locations" class="table table-bordered table-hover table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <a class="underline-text bold-text" href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/location/update-location/user_id/{$user->subject_id}") }}" title="{{ __("authenticated.Update") }}">
                            ...
                            <td>
								<div class="btn-group">
								  ...
								  <ul class="dropdown-menu">
									<li>
										<a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/location/update-location/user_id/{$user->subject_id}") }}" 
									...
									<li>
										<a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/location/update-location/user_id/{$user->subject_id}") }}" title="{{ __("authenticated.Update") }}">
											<i class="fa fa-pencil"></i>
											{{ __("authenticated.Update") }}
										</a>
									</li>
									<li>
										<a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/location/change-password/user_id/{$user->subject_id}") }}" title="{{ __("authenticated.Change Password") }}">
											<i class="fa fa-key"></i>
