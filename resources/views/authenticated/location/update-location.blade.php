...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            {{ __("authenticated.Update Location") }}
            &nbsp;
        </h1>
        <ol class="breadcrumb">
            <li><i class="fa fa-user"></i> {{ __("authenticated.Structure Entity") }}</li>
            <li>
            <a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), '/location/list-locations') }}" title="{{ __('authenticated.List Locations') }}">
                {{ __("authenticated.List Locations") }}
            </a>
            </li>
            <li class="active">
                <a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/location/update-location/user_id/{$user['user_id']}") }}" title="{{ __('authenticated.Update Location') }}">
                    {{ __("authenticated.Update Location") }}
                </a>
            </li>
        </ol>
        ...
        <div class="widget box col-md-4">
            <div class="widget-header">
                <h4>
                    ...
                    <span>{{ __("authenticated.Update Location") }}</span>
                </h4>
            </div>

            <div class="widget-content">
            {!! Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "location/update-location/user_id/{$user['user_id']}" ), 'method'=>'POST', 'class' => 'form-horizontal row-border' ]) !!}
