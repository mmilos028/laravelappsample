    ...
    <section class="content-header">
      @include('layouts.desktop_layout.header_navigation_second')
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/user/details/user_id/{$user['user_id']}") }}" title="{{ __('authenticated.Account Details') }}">
                    {{ __("authenticated.Account Details") }}
                </a>
            </li>
        </ol>
            ...
            <div class="widget box" style="margin-top:20px;">
              <div class="widget-header">
                ...
                <span class="pull-right">
                  <a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/user/change-password/user_id/{$user['user_id']}") }}">
