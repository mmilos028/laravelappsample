        ...
        <section class="content">
            ...
            <div class="widget box col-md-4">
                ...
                <div class="widget-content">
                    ...
                    <div class="form-group required">
                        <label for="password" class="col-md-3 control-label">{{__ ("authenticated.Password")}}:</label>
                        <div class="col-md-4">
                    ...
                    <div class="form-group required">
                        <label for="confirm_password" class="col-md-3 control-label">{{__ ("authenticated.Confirm Password")}}:</label>
                        <div class="col-md-4">
                    ...
                    <div class="form-group">
                        <label for="first_name" class="col-md-3 control-label">{{__ ("authenticated.First Name")}}:</label>
                        <div class="col-md-4">
    ...
    <script>
        $(document).ready(function(){
            ...
            function createNewUser(subject_type, parent_affiliate, username, password, confirm_password, first_name, last_name, mobile_phone, email, address,
                ...
                $.ajax({
                    method: "GET",
                    url: "{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "createNewUser") }}",
                    dataType: "json",
                    data: {
            ...
            function listSubjectTypes(){
                $.ajax({
                    method: "GET",
                    url: "{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "getSubjectRolesForNewUserForm") }}",
                    global: false,
                    dataType: "json",
                    //data: "result",
                    //"dataSrc": "result",
