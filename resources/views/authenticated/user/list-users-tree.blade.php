...
@section('content')
    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><i class="fa fa-tree"></i> {{ __("authenticated.Users") }}</li>
                <li class="active">
                    <a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/listUsersTree") }}" title="{{ __('authenticated.Structure View') }}">
                        {{ __("authenticated.Structure View") }}
                    </a>
                </li>
            </ol>
