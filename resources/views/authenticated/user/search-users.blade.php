	                ...
	                <table style="width: 100%;" id="search-users" class="table table-bordered table-hover table-striped pull-left">
	                    <thead>
	                        <tr class="bg-blue-active">
	                            ...
	                            <th width="150">{{ __("authenticated.Registration Date") }}</th>
	                    ...
	                    <tbody>
	                        ...
	                        <tr>
								...
								<td width="150" class="align-left" title="{{ __("authenticated.Registration Date") }}">
	                                {{ DateTimeHelper::returnDateFormatted($user->registration_date) }}
	                            </td>
								<td width="150" class="align-left" title="{{ __("authenticated.Registered By") }}">
	                                {{ $user->registered_by }}
	                            </td>
