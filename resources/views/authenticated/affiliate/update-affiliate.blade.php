...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            {{ __("authenticated.Update Affiliate") }}
            &nbsp;
        </h1>
        <ol class="breadcrumb">
            <li><i class="fa fa-user"></i> {{ __("authenticated.Users") }}</li>
            <li>
            <a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), '/affiliate/list-affiliates') }}" title="{{ __('authenticated.List Affiliates') }}">
                {{ __("authenticated.List Affiliates") }}
            </a>
            </li>
            <li class="active">
                <a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/affiliate/update-affiliate/user_id/{$user['user_id']}") }}" title="{{ __('authenticated.Update Affiliate') }}">
                    {{ __("authenticated.Update Affiliate") }}
                </a>
            </li>
        </ol>
        ...
        <div class="widget box col-md-4">
            <div class="widget-header">
                <h4>
                    ...
                    <span>{{ __("authenticated.Update Affiliate") }}</span>
                </h4>
            </div>

            <div class="widget-content">
            {!! Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "affiliate/update-affiliate/user_id/{$user['user_id']}" ), 'method'=>'POST', 'class' => 'form-horizontal row-border' ]) !!}
