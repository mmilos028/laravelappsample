...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            {{ __("authenticated.Update Operater") }}
            &nbsp;
        </h1>
        <ol class="breadcrumb">
            ...
            <li class="active">
                <a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/operater/update-operater/user_id/{$user['user_id']}") }}" title="{{ __('authenticated.Update Operater') }}">
                    {{ __("authenticated.Update Operater") }}
                </a>
            </li>
        </ol>
        ...
        <div class="widget box col-md-4">
            <div class="widget-header">
                <h4>
                    ...
                    <span>{{ __("authenticated.Update Operater") }}</span>
                </h4>
            </div>

            <div class="widget-content">
            {!! Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "operater/update-operater/user_id/{$user['user_id']}" ), 'method'=>'POST', 'class' => 'form-horizontal row-border' ]) !!}
