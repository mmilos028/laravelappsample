...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            {{ __("authenticated.Affiliate Parameter Setup") }}
            &nbsp;
        </h1>
        <ol class="breadcrumb">
            ...
            <li class="active">
                <a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/administration/affiliate-parameter-setup/parameter-setup/user_id/{$current_user['user_id']}") }}">
                    {{ __("authenticated.Affiliate Parameter Setup") }}
                </a>
            </li>
        </ol>
    ...
    <section class="content">
        ...
        <div class="widget box col-md-4">
            ...
            <div class="widget-content">
                {!! Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "administration/affiliate-parameter-setup/parameter-setup/user_id/{$current_user['user_id']}"),
        ...
        <div class="widget box col-md-4">
            <div class="widget-header">
                <h4>
                    ...
                    <span>
                    {{ __("authenticated.List Affiliate Parameters") }}
                    -
                    {{ $current_user['username'] }}
                    </span>
                </h4>
            ...
            <div class="widget-content table-responsive">
                {!! Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "administration/affiliate-parameter-setup/manage-parameter-setup/user_id/{$current_user['user_id']}"),
                'method'=>'POST', 'class' => 'form-horizontal' ]) !!}
