        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                var tree = $('#tree1').treegrid({
                    method: 'GET',
                    url: '{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/administration/entity-parameter-setup/get-structure-entity-tree-for-parameter-setup") }}',
                    ...
                    columns:[[
                        ...
                        {title: "{{ __("authenticated.Entity Type") }}",field:'subject_type_name_colourful',width:200},
                        {title: "{{ __("authenticated.Parent") }}",field:'true_parent_name',width:200},
                        {title: "{{ __("authenticated.Currency") }}",field:'currency',width:100},
                        {title: "{{ __("authenticated.Draw Model") }}",field:'draw_model',width:200},
                        {title: "{{ __("authenticated.Control / Free") }}",field:'control_free',width:100, align: "center"},
                        {title: "{{ __("authenticated.Action") }}",field:'action_column',width:100, align:"center"}
                    ]]
                });
