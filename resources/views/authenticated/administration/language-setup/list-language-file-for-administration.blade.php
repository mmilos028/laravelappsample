...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            {{ __("page_title.Administration") }}
            &nbsp;
        </h1>
        <ol class="breadcrumb">
            <li><i class="fa fa-cog"></i> {{ __("menu.Administration") }}</li>
            <li>{{ __("menu.Translation") }}</li>
            <li class="active">{{ __("page_title.Administration") }}</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="widget box col-md-4">
            <div class="widget-header">
                <h4>
                    <i class="fa fa-cog"></i>
                    <span>{{ __("page_title.Administration") }}</span>
                </h4>
            </div>
            <div class="widget-content">
                {!! Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), 'administration/language-setup/list-language-file-for-administration'), 'method'=>'POST' ]) !!}
