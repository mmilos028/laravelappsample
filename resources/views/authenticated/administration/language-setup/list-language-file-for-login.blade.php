...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            {{ __("authenticated.For Login Form") }}
            &nbsp;
        </h1>
        <ol class="breadcrumb">
            ...
            <li class="active">
                <a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/administration/language-setup/list-language-file-for-login") }}" class="noblockui">
                    {{ __("authenticated.For Login Form") }}
                </a>
            </li>
        </ol>
    ...
    <section class="content">
        ...
        <div class="widget box col-md-4">
            <div class="widget-header">
                <h4>
                    <i class="fa fa-cog"></i>
                    <span>{{ __("authenticated.For Login Form") }}</span>
                </h4>
            </div>
            <div class="widget-content">
                {!! Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), 'administration/language-setup/list-language-file-for-login'), 'method'=>'POST' ]) !!}
