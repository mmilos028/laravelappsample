...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            {{ __("authenticated.Validation") }}
            &nbsp;
        </h1>
        <ol class="breadcrumb">
            <li><i class="fa fa-cog"></i> {{ __("authenticated.Validation") }}</li>
            <li>{{ __("authenticated.Translation") }}</li>
            <li class="active">{{ __("authenticated.Validation") }}</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="widget box col-md-4">
            <div class="widget-header">
                <h4>
                    <i class="fa fa-cog"></i>
                    <span>{{ __("authenticated.Validation") }}</span>
                </h4>
            </div>
            <div class="widget-content">
                {!! Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), 'administration/language-setup/list-language-file-for-validation'), 'method'=>'POST' ]) !!}
