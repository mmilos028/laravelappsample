...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            {{ __("page_title.Manage Authenticated Language File") }}
            &nbsp;
        </h1>
        <ol class="breadcrumb">
            <li><i class="fa fa-cog"></i> {{ __("menu.Administration") }}</li>
            <li>{{ __("menu.Translation") }}</li>
            <li class="active">{{ __("page_title.Manage Authenticated Language File") }}</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="widget box col-md-4">
            <div class="widget-header">
                <h4>
                    <i class="fa fa-cog"></i>
                    <span>{{ __("page_title.Manage Authenticated Language File") }}</span>
                </h4>
            </div>
            <div class="widget-content">
                {!! Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), 'administration/language-setup/manage-authenticated-language-files'), 'method'=>'POST', 'class' => 'form-horizontal row-border' ]) !!}
                     <div class="row">
                        <div class="col-xs-12">
                ...
                {!! Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), 'administration/language-setup/manage-authenticated-language-files'), 'method'=>'POST' ]) !!}
