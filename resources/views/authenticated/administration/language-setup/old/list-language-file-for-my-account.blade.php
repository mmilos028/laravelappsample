...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">{{ __("page_title.My Account") }}</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="widget box col-md-4">
            ...
            <div class="widget-content">
                {!! Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), 'administration/language-setup/list-language-file-for-my-account'), 'method'=>'POST' ]) !!}
