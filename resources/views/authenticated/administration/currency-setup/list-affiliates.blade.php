...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/administration/currency-setup/list-affiliates") }}" class="noblockui">
                    {{ __("authenticated.List Affiliates") }}
                </a>
            </li>
        </ol>
    ...
    <section class="content">
        ...
        <div class="box table-responsive">
            {!! Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), 'administration/currency-setup/list-affiliates'), 'method'=>'POST', 'class' => 'form-horizontal row-border' ]) !!}
            <div class="box-body">
                <table class="table table-bordered table-hover table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary" href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/administration/currency-setup/add-currency-to-affiliate/user_id/{$user->subject_id}") }}" title="{{ __("authenticated.Add Currency To Affiliate") }}">
                                    <i class="fa fa-plus"></i>
                                    {{ __("authenticated.Add Currency To Affiliate") }}
                                </a>
                            </td>
                        </tr>
                        @endforeach
