...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            {{ __("authenticated.Add Currency To User") }}
            &nbsp;
        </h1>
        <ol class="breadcrumb">
            ...
            <li>
                <a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/administration/currency-setup/add-currency-to-user/user_id/{$user['user_id']}") }}">
                    {{ __("authenticated.Add Currency To User") }}
                </a>
            </li>
    ...
    <section class="content">
        ...
        <div class="widget box col-md-4">
            <div class="widget-header">
                <h4>
                    <i class="fa fa-cog"></i>
                    <span>{{ __("authenticated.Add Currency To User") }}</span>
                </h4>
            </div>

            <div class="widget-content">
                {!! Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "administration/currency-setup/add-currency-to-user/user_id/{$user['user_id']}"), 'method'=>'POST', 'class' => 'form-horizontal row-border' ]) !!}
