...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li> 
				<a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/administrator/list-administrators") }}" class="noblockui">
				{{ __("authenticated.List Administrators") }}
				</a>
			</li>
			<li> 
				<a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/administrator/details/user_id/{$user_id}") }}" class="noblockui">
            ...
            <li class="active">
                <a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/administrator/report/list-login-history/user_id/{$user_id}") }}" title="{{ __('authenticated.List Login History') }}">
                    {{ __("authenticated.List Login History") }}
                </a>
            </li>
        </ol>
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-body">
                {!! Form::open(['url' => LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), 'administrator/report/list-login-history/user_id/' . $user_id), 'method'=>'POST', 'class' => 'form-inline row-border' ]) !!}
                <table class="table">
                    <tr>
                        <td class="pull-left">                            
                        </td>
