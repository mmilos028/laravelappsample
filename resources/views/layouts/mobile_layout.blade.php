...
<head>
  ...
  <meta content="width=device-width, initial-scale=1.0, user-scalable=yes" name="viewport">
    ...
    <link rel="stylesheet" href="{{ url('js/jquery.easyui/themes/bootstrap/mobile.css') }}" />

    <link rel="stylesheet" href="{{ url('css/backoffice/table_fix.css') }}" type="text/css" />
  <link rel="stylesheet" href="{{ url('css/backoffice/table_fix_mobile.css') }}" type="text/css" />
  ...
  <link href="{{asset('vendors/pnotify/dist/pnotify.nonblock.css')}}" rel="stylesheet">
    ...
    <!-- Admin LTE app.js -->
    <script type="text/javascript" src="{{ url('adminlte/dist/js/app.min.js') }}"></script>
    <!-- JQuery block UI -->
    <script type="text/javascript" src="{{ url('js/jquery.blockUI.js') }}"></script>
    <!-- Block interface desktop code -->
    <script type="text/javascript" src="{{ url('js/backoffice/mobile/block_interface.js') }}"></script>
    ...
    <script type="text/javascript" src="{{ url('js/jquery.easyui/jquery.easyui.mobile.js') }}"></script>
    <script type="text/javascript" src="{{ url('js/jquery.easyui/datagrid-filter.js') }}"></script>

    <script type="text/javascript" src="{{ url('js/backoffice/mobile/filter-input-text.js') }}"></script>
...
<div class="wrapper">
  ...
  <div id="loadingPage" style="display: none;">
        <div class="container">
          <div class="row">
             <h3> {{ __('authenticated.Page Loading Message') }} </h3>
          </div>
          <div class="row">
            <img style="width: 90%;" alt="" src="{{ url('images/progressbar-loader.gif') }}"/>
          </div>
        </div>
  </div>

  @include('layouts.mobile_layout.header_navigation')
  ...
  @include('layouts.mobile_layout.footer')
</div>
