...
<a class="underline-text bold-text"
  href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/structure-entity/details/user_id/{$account_id}/{$account_role_name}") }}"
...
@elseif($account_role_name == config('constants.ROLE_CASHIER_TERMINAL') || $account_role_name == config('constants.SELF_SERVICE_TERMINAL') || $account_role_name == config('constants.ROLE_TERMINAL_TV'))
<a class="underline-text bold-text"
  href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/terminal/details/user_id/{$account_id}/{$account_role_name}") }}"
  title="{{ __("authenticated.Details") }}">
    {{ $account_username }}
</a>
