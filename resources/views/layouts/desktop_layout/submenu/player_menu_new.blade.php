...
<div class="row">
    <a class="btn btn-app noblockui" href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/player/list-players") }}">
        <i class="fa fa-search"></i>
        {{ __('authenticated.List Players') }}
        <span class="sr-only">(current)</span>
    </a>
    <a class="btn btn-app noblockui" href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/player/details/user_id/{$user_id}") }}">
        <i class="fa fa-info"></i>
        {{ __('authenticated.Account Details') }}
        <span class="sr-only">(current)</span>
    </a>
    <a class="btn btn-app noblockui" href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/player/update-player/user_id/{$user_id}") }}">
        <i class="fa fa-edit"></i>
        {{ __('authenticated.Update Player') }}
        <span class="sr-only">(current)</span>
    </a>
    <a class="btn btn-app noblockui" href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/player/change-password/user_id/{$user_id}") }}">
